...
function macosVersion() {
  return (
    safeTrim(spawnSync("sw_vers", ["-productVersion"], { encoding: "utf-8" }).stdout) ||
    os.release()
  );
}
...
async function readServiceStatusSummary(service, fallbackLabel) {
  try {
    ...
    const [loaded, runtime] = await Promise.all([
      ...
      service.readRuntime(serviceEnv).catch(() => void 0),
    ]);
...
const loadStatusSummaryRuntimeModule = createLazyRuntimeSurface(
  () => import("./status.summary.runtime-BbpolRU8.js"),
...
//#endregion
export {
  resolveSharedMemoryStatusSnapshot as a,
  getNodeDaemonStatusSummary as c,
  formatTokensCompact as d,
  readServiceStatusSummary as f,
  pickGatewaySelfPresence as h,
  resolveMemoryPluginStatus as i,
  formatDuration as l,
  resolveOsSummary as m,
  buildTailscaleHttpsUrl as n,
  getAgentLocalStatuses as o,
  listGatewayAgentsBasic as p,
  resolveGatewayProbeSnapshot as r,
  getDaemonStatusSummary as s,
  getStatusSummary as t,
  formatKTokens as u,
};
