...
import { A as getPositiveIntFlagValue, D as getCommandPathWithRootOptions, I as isRootHelpInvocation, M as getVerboseFlag, N as hasFlag, O as getCommandPositionalsWithRootOptions, P as hasHelpOrVersion, j as getPrimaryCommand, k as getFlagValue, y as loggingState, z as isValueToken } from "./globals-BKVgh_pY.js";
...
async function runCli(argv = process$1.argv) {
	...
	try {
		...
		if (!shouldSkipPluginCommandRegistration({
			...
			const { loadValidatedConfigForPluginRegistration } = await import("./register.subclis-BGIawxZc.js");
