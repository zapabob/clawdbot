...
import {
  a as fetchClawHubPackageVersion,
  d as satisfiesPluginApiRange,
  i as fetchClawHubPackageDetail,
  l as resolveLatestVersionFromPackage,
  n as downloadClawHubPackageArchive,
  s as parseClawHubPluginSpec,
  t as ClawHubRequestError,
  u as satisfiesGatewayMinimum,
} from "./clawhub-DIqNGx1E.js";
...
async function installPluginFromClawHub(params) {
  ...
  try {
    ...
    await fs
      .rm(path.dirname(archive.archivePath), {
        recursive: true,
        force: true,
      })
      .catch(() => void 0);
