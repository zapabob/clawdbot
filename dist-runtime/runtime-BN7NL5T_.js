import { Bb as resolveAgentRoute, Bc as listRuntimeImageGenerationProviders, Dp as matchesMentionPatterns, Ea as shouldAckReaction, Eg as buildPairingReply, Ep as buildMentionRegexes, Hs as signalMessageActions, Mp as formatInboundEnvelope, Op as matchesMentionWithExplicit, Pp as resolveEnvelopeFormatOptions, Ra as telegramMessageActions, Rb as buildAgentSessionKey, Sa as setTelegramThreadBindingMaxAgeBySessionKey, Sp as shouldComputeCommandAuthorized, Ta as removeAckReactionAfterReply, Tu as requestHeartbeatNow, Up as dispatchReplyFromConfig, Va as collectTelegramUnmentionedGroupIds, Vp as createReplyDispatcherWithTyping, Xm as getChannelActivity, Yf as recordInboundSession, Zm as recordChannelActivity, _b as resolveAgentIdentity, _m as normalizeAccountId, ab as chunkMarkdownText, ar as listWebSearchProviders, bp as hasControlCommand, cb as chunkTextWithMode, cm as createQuickReplyItems, cp as resolveTelegramToken, cv as readNumberParam, df as isVoiceCompatibleAudio, dm as pushMessageLine, fm as pushMessagesLine, gm as listLineAccountIds, hi as sendMessageSignal, hm as sendMessageLine, ia as onAgentEvent, ib as chunkByNewline, ih as resolveMarkdownTableMode, jp as formatAgentEnvelope, lb as resolveChunkMode, lm as pushFlexMessage, mi as monitorSignalProvider, mm as pushTextMessageWithQuickReplies, nh as resolveChannelGroupRequireMention, ob as chunkMarkdownTextWithMode, om as createInboundDebouncer, or as runWebSearch, pi as probeSignal, pm as pushTemplateMessage, pn as monitorLineProvider, rb as convertMarkdownTables, rv as resolveAgentTimeoutMs, sb as chunkText, sm as resolveInboundDebounceMs, sv as jsonResult, th as resolveChannelGroupPolicy, ub as resolveTextChunkLimit, um as pushLocationMessage, uv as readStringParam, vb as resolveEffectiveMessagesConfig, vh as buildTemplateMessageFromPayload, vi as dispatchReplyWithBufferedBlockDispatcher, vm as resolveDefaultLineAccountId, xa as setTelegramThreadBindingIdleTimeoutBySessionKey, xp as isControlCommandMessage, yb as resolveHumanDelayConfig, yh as probeLineBot, ym as resolveLineAccount, zc as generateImage, zp as withReplyDispatcher } from "./account-resolution-YAil9v6G.js";
...
import { S as normalizeLogLevel, c as shouldLogVerbose, d as getChildLogger } from "./globals-BKVgh_pY.js";
import { D as ensureAgentWorkspace, a as resolveAgentDir, d as resolveAgentWorkspaceDir, h as resolveSessionAgentId } from "./agent-scope-BIySJgkJ.js";
...
import { D as resolvePluginSdkScopedAliasMap, E as resolvePluginSdkAliasFile, O as shouldPreferNativeJiti, a as logWebSelfId, c as monitorWebChannel, d as sendPollWhatsApp, f as startWebLoginWithQr, h as loadWebMedia, i as handleWhatsAppAction, l as readWebSelfId, m as webAuthExists, n as getActiveWebListener, o as loginWeb, p as waitForWebLogin, r as getWebAuthAgeMs, s as logoutWeb, t as createRuntimeWhatsAppLoginTool, u as sendMessageWhatsApp, w as buildPluginLoaderJitiOptions, x as fetchRemoteMedia } from "./runtime-whatsapp-boundary-Di5xVA5u.js";
...
import { a as recordSessionMetaFromInbound, c as updateLastRoute, i as readSessionUpdatedAt, n as loadSessionStore, s as saveSessionStore } from "./store-Bo1TX1Sc.js";
...
import { a as createLazyRuntimeSurface, n as createLazyRuntimeMethodBinder, r as createLazyRuntimeModule, t as createLazyRuntimeMethod } from "./lazy-runtime-DeSnMsfk.js";
import { t as resolveMemorySearchConfig } from "./memory-search-BR1Y4hk3.js";
import { D as resolveThreadBindingMaxAgeExpiresAt, E as resolveThreadBindingInactivityExpiresAt, O as resolveThreadBindingMaxAgeMs, T as resolveThreadBindingIdleTimeoutMs } from "./thread-bindings.discord-api-z1ldYT3m.js";
import { a as setThreadBindingMaxAgeBySessionKey, i as setThreadBindingIdleTimeoutBySessionKey, l as getThreadBindingManager, o as unbindThreadBindingsBySessionKey } from "./thread-bindings-D_hD7YlT.js";
import { n as sendMessageIMessage, r as probeIMessage, t as monitorIMessageProvider } from "./runtime-api-mA2BgZV0.js";
...
const loadEmbeddedPiRuntime = createLazyRuntimeModule(() => import("./runtime-embedded-pi.runtime-h9w3ZIBY.js"));
...
const bindDiscordRuntimeMethod = createLazyRuntimeMethodBinder(createLazyRuntimeSurface(() => import("./runtime-discord-ops.runtime-8y1S4ZHL.js"), ({ runtimeDiscordOps }) => runtimeDiscordOps));
...
const bindSlackRuntimeMethod = createLazyRuntimeMethodBinder(createLazyRuntimeSurface(() => import("./runtime-slack-ops.runtime-B8OVlM3D.js"), ({ runtimeSlackOps }) => runtimeSlackOps));
...
const bindTelegramRuntimeMethod = createLazyRuntimeMethodBinder(createLazyRuntimeSurface(() => import("./runtime-telegram-ops.runtime-BxdK1ogm.js"), ({ runtimeTelegramOps }) => runtimeTelegramOps));
...
const loadMediaUnderstandingRuntime = createLazyRuntimeModule(() => import("./runtime-media-understanding.runtime-MHQ6hVam.js"));
const loadModelAuthRuntime = createLazyRuntimeModule(() => import("./runtime-model-auth.runtime-CeCNVe34.js"));
