...
import {
  ...
  E as DEFAULT_USER_FILENAME,
  T as DEFAULT_TOOLS_FILENAME,
  _ as DEFAULT_AGENTS_FILENAME,
  b as DEFAULT_HEARTBEAT_FILENAME,
  h as resolveSessionAgentId,
  v as DEFAULT_AGENT_WORKSPACE_DIR,
  w as DEFAULT_SOUL_FILENAME,
  x as DEFAULT_IDENTITY_FILENAME,
  y as DEFAULT_BOOTSTRAP_FILENAME,
...
import {
  f as DEFAULT_OPENCLAW_BROWSER_COLOR,
...
import {
  C as updateRegistry,
  E as resolveSandboxConfigForAgent,
  F as SANDBOX_AGENT_WORKSPACE_MOUNT,
  I as SANDBOX_BROWSER_SECURITY_HASH_EPOCH,
  O as isToolAllowed,
  S as updateBrowserRegistry,
  T as resolveSandboxBrowserDockerCreateConfig,
  U as expandToolGroups,
  _ as slugifySessionKey,
  a as execDockerRaw,
  b as removeBrowserRegistryEntry,
  c as readDockerPort,
  d as validateNetworkMode,
  f as resolveSandboxHostPathViaExistingAncestor,
  g as resolveSandboxWorkspaceDir,
  h as resolveSandboxScopeKey,
  i as execDocker,
  k as resolveSandboxToolPolicyForAgent,
  l as appendWorkspaceMountArgs,
  m as resolveSandboxAgentId,
  n as dockerContainerState,
  o as readDockerContainerEnvVar,
  p as splitSandboxBindSpec,
  r as ensureSandboxContainer,
  s as readDockerContainerLabel,
  t as buildSandboxCreateArgs,
  v as readBrowserRegistry,
  w as computeSandboxBrowserConfigHash,
  x as removeRegistryEntry,
  y as readRegistry,
...
} from "./main-session-lKLHSGId.js";
import { r as isLoopbackHost } from "./net-B1gQyBKw.js";
import { t as PATH_ALIAS_POLICIES } from "./path-alias-guards-Ced0dWkY.js";
import {
  J as ensureBrowserControlAuth,
  K as deleteBridgeAuthForPort,
  Y as resolveBrowserControlAuth,
  b as createBrowserRouteContext,
  q as setBridgeAuthForPort,
  t as registerBrowserRoutes,
} from "./routes-DbO6sePn.js";
import {
  n as installBrowserCommonMiddleware,
  t as installBrowserAuthMiddleware,
} from "./server-middleware-Ctl1kLBT.js";
import {
  c as syncSkillsToWorkspace,
  f as assertSandboxPath,
  m as resolveSandboxPath,
  p as resolveSandboxInputPath,
...
async function ensureSandboxBrowserImage(image) {
  if ((await execDocker(["image", "inspect", image], { allowFailure: true })).code === 0) return;
  throw new Error(
...
var SandboxFsPathGuard = class {
  ...
  resolveMountByContainerPath(containerPath) {
    ...
    for (const mount of this.mountsByContainer)
      if (isPathInsideContainerRoot(normalizeContainerPath$1(mount.containerRoot), normalized))
        return mount;
    return null;
  }
...
var SandboxFsBridgeImpl = class {
  constructor(sandbox) {
    ...
    this.pathGuard = new SandboxFsPathGuard({
      mountsByContainer: [...this.mounts].toSorted(
...
export {
  ...
  resolveSandboxRuntimeStatus as b,
  buildSandboxEnv as c,
  coerceEnv as d,
  deriveSessionName as f,
  resolveWorkdir as g,
  resolveSandboxWorkdir as h,
  ...
  buildDockerExecArgs as s,
  listSandboxBrowsers as t,
  clampWithDefault as u,
  truncateMiddle as v,
  formatSandboxToolPolicyBlockedMessage as y,
};
