...
import { a as resolveNativeSkillsEnabled } from "./commands-Bhtcd2Bj.js";
...
import { t as collectIncludePathsRecursive } from "./includes-scan-Cy5yfDHR.js";
...
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-D6iR1-jr.js";
...
function loadSkillsModule() {
  skillsModulePromise ??= import("./skills-DJFQR7uR.js");
  return skillsModulePromise;
}
function loadConfigModule() {
  configModulePromise ??= import("./config-CceVW_3T.js");
...
async function collectPluginsTrustFindings(params) {
  ...
  if (pluginDirs.length > 0) {
    ...
    if (!(Array.isArray(allow) && allow.length > 0)) {
      ...
      const hasSecretInput = (value) =>
        hasConfiguredSecretInput(value, params.cfg.secrets?.defaults);
      const hasAccountStringKey = (account, key) =>
        Boolean(account && typeof account === "object" && hasString(account[key]));
      const hasAccountSecretInputKey = (account, key) =>
        Boolean(account && typeof account === "object" && hasSecretInput(account[key]));
...
//#endregion
export {
  collectSandboxBrowserHashLabelFindings as a,
  readConfigSnapshotForAudit as c,
  collectPluginsTrustFindings as i,
  collectInstalledSkillsCodeSafetyFindings as n,
  collectStateDeepFilesystemFindings as o,
  collectPluginsCodeSafetyFindings as r,
  collectWorkspaceSkillSymlinkEscapeFindings as s,
