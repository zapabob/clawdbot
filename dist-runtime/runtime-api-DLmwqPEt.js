...
import {
  Cb as createDiscordActionGate,
  Gs as createUnionActionGate,
  Ks as listTokenSourcedAccounts,
  Tb as listEnabledDiscordAccounts,
  dv as stringEnum,
  f as handleDiscordMessageAction,
...
function describeDiscordMessageTool({ cfg }) {
  ...
  return {
    ...
    schema: {
      properties: { components: Type.Optional(createDiscordMessageToolComponentsSchema()) },
    },
  };
}
