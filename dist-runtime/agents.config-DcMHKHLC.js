...
import {
  ...
  r as parseIdentityMarkdown$1,
  t as identityHasValues,
} from "./identity-file-CuigvXSN.js";
...
function resolveAgentName(cfg, agentId) {
  return (
    listAgentEntries(cfg)
      .find((agent) => normalizeAgentId(agent.id) === normalizeAgentId(agentId))
      ?.name?.trim() || void 0
  );
}
...
//#endregion
export {
  parseIdentityMarkdown as a,
  loadAgentIdentity as i,
  buildAgentSummaries as n,
  pruneAgentConfig as o,
