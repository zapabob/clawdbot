import { $g as createOpenProviderGroupPolicyWarningCollector, $h as patchChannelConfigForAccount, $s as resolveSignalAccount, Ac as readBooleanParam, Af as createChannelDirectoryAdapter, Ag as createHybridChannelConfigAdapter, Am as requestBodyErrorToText, Ba as auditTelegramGroupMembership, Bd as sendTelegramPayloadMessages, Bg as createEmptyChannelResult, Bh as createPromptParsedAllowFromForAccount, C_ as applySetupAccountConfigPatch, Cf as parseTelegramTarget, Cs as parseSlackBlocksInput, Da as createAccountStatusSink, Db as resolveDefaultDiscordAccountId, Dg as createLoggedPairingApprovalNotifier, Dm as isRequestBodyLimitError, Do as normalizeAllowListLower, Ds as resolveSlackAccount, E_ as migrateBaseNameToDefaultAccount, Es as resolveDefaultSlackAccountId, Fa as buildTelegramExecApprovalButtons, Fn as buildModelsProviderData, Fo as listSlackMessageActions, Fp as dispatchInboundReplyWithBase, Gg as composeAccountWarningCollectors, Gm as buildExecApprovalPendingReplyPayload, H as parseDiscordTarget, Ha as looksLikeSignalTargetId, Hb as createAccountListHelpers, Hg as resolveOutboundSendDep, Hh as createTopLevelChannelAllowFromSetter, Hs as signalMessageActions, Ih as createAccountScopedAllowFromSection, Io as isSlackInteractiveRepliesEnabled, Ip as createChannelReplyPipeline, Jd as sendTypingTelegram, Jg as createAllowlistProviderOpenWarningCollector, Jm as resolveExecApprovalCommandDisplay, Js as resolveSignalPeerId, Kb as resolveMergedAccountConfig, Kg as composeWarningCollectors, Kp as deliverFormattedTextWithAttachments, Lg as attachChannelToResult, Lh as createAccountScopedGroupAccessSection, Lo as listSlackDirectoryGroupsFromConfig, M_ as normalizeInteractiveReply, Mf as buildTelegramGroupPeerId, Mg as createScopedDmSecurityResolver, Mn as resolveExactLineGroupConfigKey, Mo as resolveSlackGroupRequireMention, Nb as normalizeOutboundThreadId, Ng as formatTrimmedAllowFromEntries, No as resolveSlackGroupToolPolicy, Np as formatInboundFromLabel$1, Ny as createDedupeCache, O_ as patchScopedAccountConfig, Oa as runPassiveAccountLifecycle, Ob as resolveDiscordAccount, Of as listResolvedDirectoryEntriesFromSources, Og as createPairingPrefixStripper, Os as resolveSlackReplyToMode, Pa as registerPluginHttpRoute, Pb as buildOutboundBaseSessionKey, Pd as collectTelegramStatusIssues, Pg as mapAllowFromEntries, Po as extractSlackToolSend, Qg as createOpenProviderConfiguredRouteWarningCollector, Qp as resolveSendableOutboundReplyParts, Qs as resolveDefaultSignalAccountId, Rb as buildAgentSessionKey, Rg as attachChannelToResults, Rh as createAllowFromSection, Ro as listSlackDirectoryPeersFromConfig, Rs as buildPendingHistoryContextFromMap, S_ as applyAccountNameToChannelSection, Sb as inspectDiscordAccount, Sf as resolveTelegramExecApprovalTarget, Sh as formatNormalizedAllowFromEntries, So as buildSlackThreadingToolContext, Tf as listTelegramDirectoryPeersFromConfig, Tg as createChannelPairingController, Ts as listSlackAccountIds, Ua as normalizeSignalMessagingTarget, Ub as describeAccountSnapshot, Ug as buildOpenGroupPolicyRestrictSendersWarning, Uh as createTopLevelChannelDmPolicy, Us as createMessageToolButtonsSchema, Va as collectTelegramUnmentionedGroupIds, Vb as buildSecretInputSchema, Vg as createRawChannelSendResultAdapter, Vh as createStandardChannelSetupStatus, Vo as buildSlackInteractiveBlocks, Vs as recordPendingHistoryEntryIfEnabled, Wb as listCombinedAccountIds, Wg as buildOpenGroupPolicyWarning, Wh as createTopLevelChannelDmPolicySetter, Ws as createMessageToolCardSchema, Xg as createConditionalWarningCollector, Xh as noteChannelLookupSummary, Xp as resolveOutboundMediaUrls, Xs as resolveSignalSender, Yg as createAllowlistProviderRouteAllowlistWarningCollector, Yh as noteChannelLookupFailure, Yp as isNumericTargetId, Ys as resolveSignalRecipient, Zg as createOpenGroupPolicyRestrictSendersWarningCollector, Zh as parseMentionOrPrefixedId, Zs as listSignalAccountIds, __ as PAIRING_APPROVED_MESSAGE, _f as resolveTelegramGroupRequireMention, _g as createChatChannelPlugin, _p as resolveMentionGatingWithBypass, a as looksLikeDiscordTargetId, ac as parseIMessageTarget, ag as resolveAccountIdForConfigure, ap as mergeTelegramAccountConfig, as as resolveSlackChannelId, av as createActionGate, b_ as buildCatchallMultiAccountChannelSchema, ba as monitorTelegramProvider, bg as stripChannelTargetPrefix, bm as createRuntimeDirectoryLiveAdapter, c as resolveDiscordGroupRequireMention, c_ as createStaticReplyToModeResolver, cf as buildAgentMediaPayload, cg as runSingleChannelSecretStep, cv as readNumberParam, d as listDiscordDirectoryPeersFromConfig, d_ as buildTokenChannelStatusSummary, dc as resolveIMessageGroupToolPolicy, dg as setSetupChannelEnabled, dn as lineSetupAdapter, e_ as projectAccountConfigWarningCollector, ep as lookupTelegramChatId, eu as enablePluginInConfig, f_ as collectStatusIssuesFromLastError, fc as listIMessageAccountIds, ff as parseTelegramReplyToMessageId, fg as splitSetupEntries, fn as LineChannelConfigSchema, gg as createChannelPluginBase, gi as markdownToSignalTextChunks, gm as listLineAccountIds, gp as logTypingFailure, hf as normalizeTelegramMessagingTarget, hg as buildChannelOutboundSessionRoute, hp as logInboundDrop, ht as TextDisplay, ic as normalizeIMessageHandle, ih as resolveMarkdownTableMode, ip as listTelegramAccountIds, is as parseSlackTarget, j_ as emptyPluginConfigSchema, jf as createEmptyChannelDirectoryAdapter, jg as createScopedChannelConfigAdapter, jn as createLoggerBackedRuntime, k_ as prepareScopedSetupConfig, ka as waitUntilAbort, kf as listResolvedDirectoryUserEntriesFromAllowFrom, kg as adaptScopedAccountAccessor, km as readRequestBodyWithLimit, kn as createFixedWindowRateLimiter, l as resolveDiscordGroupToolPolicy, l_ as buildBaseChannelStatusSummary, lf as resolveChannelMediaMaxBytes, lt as fetchChannelPermissionsDiscord, lv as readReactionParams, m_ as createDefaultChannelRuntimeState, mc as resolveIMessageAccount, mf as looksLikeTelegramTargetId, mn as processLineMessage, ms as createSlackWebClient, mt as Separator, n as resolveAccountWithDefaultFallback, n_ as projectConfigAccountIdWarningCollector, ng as promptParsedAllowFromForAccount, nh as resolveChannelGroupRequireMention, nm as sendPayloadWithChunkedTextAndMedia, o as normalizeDiscordMessagingTarget, og as resolveEntriesWithOptionalToken, op as resolveDefaultTelegramAccountId, os as SLACK_TEXT_LIMIT, p_ as createComputedAccountStatusAdapter, pc as resolveDefaultIMessageAccountId, pf as parseTelegramThreadId, qg as createAllowlistProviderGroupPolicyWarningCollector, qh as mergeAllowFromEntries, qm as getExecApprovalReplyMetadata, qp as deliverTextOrMediaReply, qs as looksLikeUuid, r as collectDiscordStatusIssues, rc as looksLikeIMessageExplicitTargetId, rg as promptResolvedAllowFrom, ro as parseTelegramTopicConversation, rp as inspectTelegramAccount, s as normalizeDiscordOutboundTarget, sg as resolveSetupAccountId, sp as resolveTelegramAccount, sv as jsonResult, t_ as projectAccountWarningCollector, tc as inferIMessageTargetChatType, tg as promptLegacyChannelAllowFromForAccount, u as listDiscordDirectoryGroupsFromConfig, u_ as buildProbeChannelStatusSummary, ub as resolveTextChunkLimit, uc as resolveIMessageGroupRequireMention, ug as setChannelDmPolicyWithAllowFrom, un as lineSetupWizard, uv as readStringParam, v_ as clearAccountEntryFields, vf as resolveTelegramGroupToolPolicy, vg as defineChannelPluginEntry, vm as resolveDefaultLineAccountId, w_ as createEnvPatchedAccountSetupAdapter, wb as listDiscordAccountIds, wf as listTelegramDirectoryGroupsFromConfig, ws as inspectSlackAccount, x_ as buildChannelConfigSchema, xf as isTelegramExecApprovalClientEnabled, xg as stripTargetKindPrefix, xh as formatAllowFromLowercase, xm as createRuntimeOutboundDelegates, y_ as AllowFromListSchema, ya as probeTelegram, yf as createRestrictSendersChannelSecurity, yg as defineSetupPluginEntry, ym as resolveLineAccount, za as extractToolSend, zg as createAttachedChannelResultAdapter, zh as createLegacyCompatChannelDmPolicy, zs as clearHistoryEntriesIfEnabled, zy as isChannelConfigured } from "./account-resolution-YAil9v6G.js";
import { B as BlockStreamingCoalesceSchema$1, C as DiscordConfigSchema, D as TelegramConfigSchema, E as SlackConfigSchema, H as GroupPolicySchema$1, K as requireOpenAllowFrom, T as SignalConfigSchema, U as MarkdownConfigSchema$1, V as DmPolicySchema$1, W as ReplyRuntimeConfigSchemaShape, w as IMessageConfigSchema, z as ToolPolicySchema$1 } from "./io-BeL7sW7Y.js";
import { g as normalizeAccountId, h as DEFAULT_ACCOUNT_ID, u as resolveThreadSessionKeys$1, v as isBlockedObjectKey } from "./session-key-0JD9qg4o.js";
import { d as isRecord, m as normalizeE164 } from "./utils-DGUUVa38.js";
import { a as hasConfiguredSecretInput, c as normalizeResolvedSecretInputString, l as normalizeSecretInputString } from "./types.secrets-BEA4gMCN.js";
import { d as resolveAgentWorkspaceDir, f as resolveDefaultAgentId } from "./agent-scope-BIySJgkJ.js";
import { i as listChatChannels, n as formatChannelSelectionLine, r as getChatChannelMeta, t as formatChannelPrimerLine, u as CHAT_CHANNEL_ORDER } from "./registry-B5KsIQB2.js";
...
import { h as loadWebMedia, v as getAgentScopedMediaLocalRoots } from "./runtime-whatsapp-boundary-Di5xVA5u.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-Bwkm96YC.js";
import { n as loadSessionStore } from "./store-Bo1TX1Sc.js";
import { d as resolveNestedAllowlistDecision, l as resolveChannelEntryMatchWithFallback, o as buildChannelKeyCandidates, r as resolveAllowlistMatchSimple, s as normalizeChannelSlug } from "./plugins-AUGbKgu9.js";
...
import { n as parseOptionalDelimitedEntries, r as resolveChannelDefaultAccountId } from "./helpers-BQ7Yhtpb.js";
import { C as resolveDefaultGroupPolicy, S as resolveAllowlistProviderRuntimeGroupPolicy, T as warnMissingProviderGroupPolicyFallbackOnce, _ as resolveDangerousNameMatchingEnabled, a as resolveDmGroupAccessWithLists, f as evaluateMatchedGroupAccessForPolicy, g as isDangerousNameMatchingEnabled, i as resolveDmGroupAccessWithCommandGate, l as resolveControlCommandGate, m as evaluateSenderGroupAccessForPolicy, n as readStoreAllowFromForDmPolicy, o as resolveEffectiveAllowFromLists, t as DM_GROUP_ACCESS_REASON, x as GROUP_POLICY_BLOCKED_LABEL } from "./dm-policy-shared-D3Y8oBe8.js";
...
import { i as createLazyRuntimeNamedExport, r as createLazyRuntimeModule } from "./lazy-runtime-DeSnMsfk.js";
import { a as resolveConfiguredFromCredentialStatuses, o as resolveConfiguredFromRequiredCredentialStatuses, r as projectCredentialSnapshotFields } from "./account-snapshot-fields-foxLy_VQ.js";
import { D as listBlueBubblesAccountIds, M as normalizeBlueBubblesServerUrl, O as resolveBlueBubblesAccount, S as getCachedBlueBubblesPrivateApiStatus, T as isMacOS26OrHigher, _ as resolveBlueBubblesGroupRequireMention, a as inferBlueBubblesTargetChatType, b as BLUEBUBBLES_ACTION_NAMES, c as looksLikeBlueBubblesTargetId, d as parseBlueBubblesAllowTarget, f as parseBlueBubblesTarget, g as collectBlueBubblesStatusIssues, k as resolveDefaultBlueBubblesAccountId, l as normalizeBlueBubblesHandle, m as setBlueBubblesRuntime, r as extractHandleFromChatGuid, s as looksLikeBlueBubblesExplicitTargetId, t as DEFAULT_WEBHOOK_PATH$2, u as normalizeBlueBubblesMessagingTarget, v as resolveBlueBubblesGroupToolPolicy, y as BLUEBUBBLES_ACTIONS } from "./webhook-shared-DemgUaBR.js";
import { t as createPluginRuntimeStore } from "./runtime-store-Dh8fm3Ic.js";
import { n as createDiscordSetupWizardProxy, r as discordSetupAdapter } from "./setup-core-CQ8M6fSi.js";
import { n as listThreadBindingsBySessionKey, o as unbindThreadBindingsBySessionKey, t as autoBindSpawnedDiscordSubagent } from "./thread-bindings-D_hD7YlT.js";
...
import { C as feishuSetupWizard, D as looksLikeFeishuId, E as feishuSetupAdapter, F as listFeishuAccountIds, I as resolveDefaultFeishuAccountId, L as resolveFeishuAccount, O as normalizeFeishuTarget, P as listEnabledFeishuAccounts, R as resolveFeishuCredentials, S as createPersistentDedupe, b as buildFeishuConversationId, g as setFeishuRuntime, h as getFeishuRuntime, j as createFeishuClient, x as parseFeishuConversationId, y as getFeishuThreadBindingManager } from "./send-DnN1-Sre.js";
import { a as listFeishuDirectoryPeers, i as listFeishuDirectoryGroups, l as registerFeishuChatTools, u as resolveToolsConfig } from "./reactions--IAyT0-F.js";
...
import { a as imessageSetupAdapter, c as setIMessageRuntime, n as createIMessageSetupWizardProxy, s as getIMessageRuntime } from "./setup-core-C5AO0Myq2.js";
import { n as createSignalSetupWizardProxy, o as signalSetupAdapter } from "./setup-core-w7EBN6u4.js";
import { i as resolveZaloAccount, n as listZaloAccountIds, r as resolveDefaultZaloAccountId, t as listEnabledZaloAccounts } from "./accounts-DD9J-j_R.js";
import { n as zaloSetupWizard, r as zaloSetupAdapter, t as chunkTextForOutbound } from "./runtime-api-j7kJbVIJ.js";
import { n as setZaloRuntime } from "./runtime-CEBJRx-j.js";
import { n as collectDiscordAuditChannelIds, t as auditDiscordChannelPermissions } from "./audit-BuJR4P8I.js";
...
import { n as normalizeSlackMessagingTarget, t as looksLikeSlackTargetId } from "./slack-yOsQuAbT.js";
...
const loadBlueBubblesActionsRuntime = createLazyRuntimeNamedExport(() => import("./actions.runtime-BJp2XtOE.js"), "blueBubblesActionsRuntime");
...
const blueBubblesSetupWizard = {
	...
	prepare: async ({ cfg, accountId, prompter, credentialValues }) => {
		...
		return {
			cfg: wantsCustomWebhook ? cfg : applyBlueBubblesSetupPatch(cfg, accountId, { webhookPath: DEFAULT_WEBHOOK_PATH$2 }),
			credentialValues: {
				...credentialValues,
...
const loadBlueBubblesChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-CuWAMkVx.js"), "blueBubblesChannelRuntime");
...
const loadFeishuChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-C4GlVrgW.js"), "feishuChannelRuntime");
...
const loadIMessageChannelRuntime = createLazyRuntimeModule(() => import("./channel.runtime-fZB-0Kn4.js"));
...
function resolveTelegramOutboundSessionRoute(params) {
	...
	return {
		sessionKey: (resolvedThreadId && !isGroup ? resolveThreadSessionKeys$1({
			baseSessionKey,
...
const loadZaloActionsRuntime = createLazyRuntimeNamedExport(() => import("./actions.runtime-BY01pzCV.js"), "zaloActionsRuntime");
...
const loadZaloChannelRuntime = createLazyRuntimeModule(() => import("./channel.runtime-BJ3StsIh.js"));
