...
import { a as removeCommandByName, i as registerSubCliCommands, o as reparseProgramFromActionArgs } from "./register.subclis-cV5s4xy_.js";
...
const coreEntries = [
	...
	},
	{
		...
		register: async ({ program, ctx }) => {
			(await import("./register.agent-ohViUfH2.js")).registerAgentCommands(program, { agentChannelOptions: ctx.agentChannelOptions });
		}
	},
	{
		commands: [
		...
		register: async ({ program }) => {
			(await import("./register.status-health-sessions-BgEj8jzJ.js")).registerStatusHealthSessionsCommands(program);
		}
	},
	{
		commands: [{
