...
function createPinnedDispatcher(pinned, policy, ssrfPolicy) {
  ...
  if (!policy || policy.mode === "direct")
    return new Agent({ connect: withPinnedLookup(lookup, policy?.connect) });
...
//#endregion
export {
  isBlockedHostnameOrIp as a,
  loadUndiciRuntimeDeps as c,
  createPinnedLookup as i,
  normalizeHostname as l,
  closeDispatcher as n,
  isPrivateNetworkAllowedByPolicy as o,
  createPinnedDispatcher as r,
  resolvePinnedHostnameWithPolicy as s,
