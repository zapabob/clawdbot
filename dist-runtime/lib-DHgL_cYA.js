...
import { C as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, n as CouldNotDetermineFileTypeError } from "./BasicParser-IVlnAwLV.js";
import { n as fromStream, r as fromBuffer, t as fromFile } from "./lib-DoScZMXj.js";
import { l as toRatio, n as decodeString } from "./Util-B3rr1RwO.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-B-dn4oK9.js";
import { a as textDecode, t as APEv2Parser } from "./APEv2Parser-DLWIwqVB.js";
import { r as hasID3v1Header } from "./ID3v1Parser-D3tX7P_S.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-Db-B8VKA.js";
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-C18PkrGe.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-DsT_I9IV.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-0SSI_Aux.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-DFT9iw1r.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-DEj4fSvQ.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-CRfWvFnA.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-Dz1l9ezI.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-CqZ1z8Ca.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-CvgaG12I.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-DtWH_ZLd.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-B_qghHDw.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-ffBQSxSx.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-DPNkvnxm.js")).WaveParser;
	}
};
//#endregion
