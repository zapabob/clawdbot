...
import { ir as listConfiguredWebSearchProviders } from "./account-resolution-YAil9v6G.js";
...
import { y as DEFAULT_BOOTSTRAP_FILENAME } from "./agent-scope-BIySJgkJ.js";
...
import { d as restoreTerminalState } from "./subsystem-BZRyMoTO.js";
...
async function finalizeSetupWizard(options) {
  ...
  if (process.platform === "linux" && systemdAvailable) {
    const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-C4PdCDTi.js");
  ...
  if (webSearchProvider) {
    const { resolveExistingKey, hasExistingKey, hasKeyInEnv } =
      await import("./onboard-search-C7RGizVv.js");
    ...
    const { hasExistingKey, hasKeyInEnv } = await import("./onboard-search-C7RGizVv.js");
