import {
  ...
  va as CONTEXT_WINDOW_HARD_MIN_TOKENS,
...
import { i as buildModelAliasIndex, l as modelKey } from "./model-selection-CNzhkJya.js";
import {
  n as normalizeSecretInput,
  t as normalizeOptionalSecretInput,
} from "./normalize-secret-input-BVTW5wne.js";
import {
  r as ensureApiKeyFromEnvOrPrompt,
  u as applyPrimaryModel,
} from "./provider-auth-helpers-C2BVZ0gX.js";
import { o as isSecretRef } from "./types.secrets-BEA4gMCN.js";
import "./ollama-defaults-BkItzGjz.js";
...
function buildEndpointIdFromUrl(baseUrl) {
  try {
    ...
    return (
      normalizeEndpointId(
        `custom-${url.hostname.replace(/[^a-z0-9]+/gi, "-").toLowerCase()}${url.port ? `-${url.port}` : ""}`,
      ) || "custom"
    );
  } catch {
    return "custom";
...
//#endregion
export {
  resolveCustomProviderId as a,
  promptCustomApiConfig as i,
  applyCustomApiConfig as n,
  parseNonInteractiveCustomApiFlags as r,
  CustomApiError as t,
};
