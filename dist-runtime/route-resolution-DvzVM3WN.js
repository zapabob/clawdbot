...
function resolveBindingPersona(cfg, binding) {
  if (!binding) return {};
  const username = (`🤖 ${binding.label?.trim() || binding.agentId}`.trim() || "🤖 agent").slice(
    0,
    80,
  );
  let avatarUrl;
...
async function resolveDiscordThreadParentInfo(params) {
  ...
  let parentId =
    threadChannel.parentId ?? threadChannel.parent?.id ?? channelInfo?.parentId ?? void 0;
...
//#endregion
export {
  resolveForwardedMediaList as C,
  buildDiscordInboundAccessContext as E,
  resolveDiscordMessageText as S,
  buildDiscordGroupSystemPrompt as T,
  resolveDiscordWebhookId as _,
  handleDiscordDmCommandDecision as a,
  resolveDiscordChannelInfo as b,
  resolveDiscordAutoThreadReplyPlan as c,
  resolveDiscordThreadStarter as d,
  deliverDiscordReply as f,
  resolveDiscordSenderIdentity as g,
  resolveReplyContext as h,
  resolveDiscordEffectiveRoute as i,
  resolveDiscordThreadChannel as l,
  buildGuildLabel as m,
  resolveDiscordBoundConversationRoute as n,
  resolveDiscordDmCommandAccess as o,
  buildDirectLabel as p,
  resolveDiscordConversationRoute as r,
  sendTyping as s,
  buildDiscordRoutePeer as t,
  resolveDiscordThreadParentInfo as u,
  buildDiscordMediaPayload as v,
  resolveMediaList as w,
  resolveDiscordMessageChannelId as x,
  hasDiscordMessageStickers as y,
};
