import {
  ...
  Ao as resolveSlackAllowListMatch,
  As as resolveSlackBotToken,
  Bb as resolveAgentRoute,
  Cm as resolveAgentOutboundIdentity,
  Co as hasSlackThreadParticipation,
...
import { t as resolveConversationLabel } from "./conversation-label-DjXilbMM.js";
import {
  ...
  d as evaluateGroupRouteAccessForPolicy,
...
import {
  Qt as mapStreamingModeToSlackLegacyDraftStreamMode,
  en as resolveSlackNativeStreaming,
  g as writeConfigFile,
  s as loadConfig,
  tn as resolveSlackStreamingMode,
} from "./io-BeL7sW7Y.js";
import { h as sleepWithAbort, m as computeBackoff } from "./level-overrides-DfXHgPB9.js";
...
import {
  n as normalizeSlackWebhookPath,
  r as registerSlackHttpHandler,
} from "./registry-DIdl_z8Z.js";
import {
  a as resolveSlackThreadTs,
  i as readSlackReplyBlocks,
  n as deliverReplies,
  t as createSlackReplyDeliveryPlan,
} from "./replies-DQh1Kx2g.js";
import {
  n as resolveSlackUserAllowlist,
  t as resolveSlackChannelAllowlist,
} from "./resolve-channels-DRbGghq8.js";
import { t as generateSecureToken } from "./secure-random-BvhfCHPg.js";
import {
  c as normalizeMainKey,
  g as normalizeAccountId,
  u as resolveThreadSessionKeys,
} from "./session-key-0JD9qg4o.js";
import { m as resolveSessionKey } from "./sessions-CD_-8zJN.js";
import { n as require_ms } from "./src-C22Uzyjn.js";
import { c as updateLastRoute, i as readSessionUpdatedAt } from "./store-Bo1TX1Sc.js";
...
var require_errors$2 = /* @__PURE__ */ __commonJSMin((exports) => {
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.CustomFunctionCompleteFailError =
    exports.CustomFunctionCompleteSuccessError =
    exports.CustomFunctionInitializationError =
    exports.WorkflowStepInitializationError =
    exports.MultipleListenerError =
    exports.HTTPReceiverDeferredRequestError =
    exports.ReceiverInconsistentStateError =
    exports.ReceiverAuthenticityError =
    exports.ReceiverMultipleAckError =
    exports.CustomRouteInitializationError =
    exports.InvalidCustomPropertyError =
    exports.ContextMissingPropertyError =
    exports.AuthorizationError =
    exports.AssistantMissingPropertyError =
    exports.AssistantInitializationError =
    exports.AppInitializationError =
    exports.asCodedError =
    exports.UnknownError =
    exports.ErrorCode =
    exports.isCodedError =
      void 0;
  ...
  (function (ErrorCode) {
    ...
    ErrorCode["HTTPReceiverDeferredRequestError"] =
      "slack_bolt_http_receiver_deferred_request_error";
    /**
    ...
    ErrorCode["CustomFunctionInitializationError"] =
      "slack_bolt_custom_function_initialization_error";
    ErrorCode["CustomFunctionCompleteSuccessError"] =
      "slack_bolt_custom_function_complete_success_error";
...
var require_builtin = /* @__PURE__ */ __commonJSMin((exports) => {
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.directMention =
    exports.subtype =
    exports.ignoreSelf =
    exports.matchEventType =
    exports.matchCommandName =
    exports.matchMessage =
    exports.matchConstraints =
    exports.autoAcknowledge =
    exports.onlyViewActions =
    exports.onlyEvents =
    exports.onlyOptions =
    exports.onlyCommands =
    exports.onlyShortcuts =
    exports.onlyActions =
    exports.isSlackEventMiddlewareArgsOptions =
      void 0;
  ...
  function matchConstraints(constraints) {
    return async ({ payload, body, next, context }) => {
      ...
      if ("block_id" in constraints || "action_id" in constraints) {
        ...
        if (constraints.block_id !== void 0)
        ...
        if (constraints.action_id !== void 0)
  ...
  const ignoreSelf = async (args) => {
    ...
    if (isEventArgs(args)) {
      ...
      if (
        ...
        !["member_joined_channel", "member_left_channel"].includes(args.event.type)
      )
        return;
    }
    await args.next();
  ...
  const directMention = async ({ message, context, next }) => {
    if (context.botUserId === void 0)
      throw new errors_1.ContextMissingPropertyError(
        "botUserId",
...
var require_CustomFunction = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  function validate(callbackId, middleware) {
    if (typeof callbackId !== "string")
      throw new errors_1.CustomFunctionInitializationError(
        "CustomFunction expects a callback_id as the first argument",
      );
    if (typeof middleware !== "function" && !Array.isArray(middleware))
      throw new errors_1.CustomFunctionInitializationError(
        "CustomFunction expects a function or array of functions as the second argument",
      );
    if (Array.isArray(middleware)) {
      for (const fn of middleware)
        if (!(fn instanceof Function))
          throw new errors_1.CustomFunctionInitializationError(
            "All CustomFunction middleware must be functions",
          );
    }
  }
  ...
  function createFunctionComplete(context, client) {
    ...
    if (!functionExecutionId)
      throw new errors_1.CustomFunctionCompleteSuccessError("No function_execution_id found");
    let called = false;
  ...
  function createFunctionFail(context, client) {
    const { functionExecutionId } = context;
    if (!functionExecutionId)
      throw new errors_1.CustomFunctionCompleteFailError("No function_execution_id found");
    let called = false;
    const fail = (params) => {
      called = true;
...
var require_helpers = /* @__PURE__ */ __commonJSMin((exports) => {
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.assertNever =
    exports.isEventTypeToSkipAuthorize =
    exports.isBodyWithTypeEnterpriseInstall =
    exports.getTypeAndConversation =
    exports.IncomingEventType =
      void 0;
  /**
  ...
  function getTypeAndConversation(body) {
    ...
    if (body.type === "view_submission" || body.type === "view_closed")
      return { type: IncomingEventType.ViewAction };
    return {};
  }
  ...
  function conversationContext(store) {
    return async ({ body, context, next, logger }) => {
      ...
      if (conversationId !== void 0) {
        context.updateConversation = (conversation, expiresAt) =>
        ...
        try {
          ...
          if (e.message !== void 0 && e.message !== "Conversation not found")
            logger.debug(
              `Conversation context failed loading for ID: ${conversationId}, error: ${e.message}`,
            );
        }
...
var require_errors$1 = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  exports.AuthorizationError =
    exports.UnknownError =
    exports.MissingCodeError =
    exports.InvalidStateError =
    exports.MissingStateError =
    exports.GenerateInstallUrlError =
    exports.InstallerInitializationError =
    exports.ErrorCode =
      void 0;
  /**
...
var require_callback_options = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  function defaultCallbackSuccess(installation, _options, _req, res) {
    var redirectUrl;
    if (isNotOrgInstall(installation) && installation.appId !== void 0)
      redirectUrl = "slack://app?team="
        .concat(installation.team.id, "&id=")
        .concat(installation.appId);
    else if (isOrgInstall(installation))
      redirectUrl = ""
        .concat(installation.enterpriseUrl, "manage/organization/apps/profile/")
        .concat(installation.appId, "/workspaces/add");
  ...
  function defaultCallbackFailure(error, _options, _req, res) {
    ...
    var html =
      "<html>\n  <head>\n  <style>\n  body {\n    padding: 10px 15px;\n    font-family: verdana;\n    text-align: center;\n  }\n  </style>\n  </head>\n  <body>\n  <h2>Oops, Something Went Wrong!</h2>\n  <p>Please try again or contact the app owner (reason: ".concat(
  ...
  exports.default = (function () {
    function FileInstallationStore(_a) {
      var _b = _a === void 0 ? {} : _a,
        _c = _b.baseDir,
        baseDir =
          _c === void 0 ? "".concat((0, node_os_1$1.homedir)(), "/.bolt-js-app-installation") : _c,
        clientId = _b.clientId,
        _d = _b.historicalDataEnabled,
        historicalDataEnabled = _d === void 0 ? true : _d;
      ...
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          ...
          installationDir = this.getInstallationDir(
            enterprise === null || enterprise === void 0 ? void 0 : enterprise.id,
          ...
          if (logger !== void 0) {
            ...
            logger.info(
              "Storing installation in "
                .concat(installationDir, " for ")
                .concat(JSON.stringify(dataForLogging)),
            );
          ...
          try {
            ...
            writeToFile(
              "".concat(installationDir, "/user-").concat(user.id, "-latest"),
              installationData,
            );
            if (this.historicalDataEnabled) {
              ...
              writeToFile(
                "".concat(installationDir, "/user-").concat(user.id, "-").concat(currentUTC),
                installationData,
              );
            }
          } catch (err) {
            throw new Error(
              "Failed to save installation to FileInstallationStore (error: ".concat(err, ")"),
            );
          }
          return [2];
        });
    ...
    FileInstallationStore.prototype.fetchInstallation = function (query, logger) {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          ...
          if (logger !== void 0)
            logger.info(
              "Retrieving installation from "
                .concat(installationDir, " with the following query: ")
                .concat(JSON.stringify(query)),
            );
          if (isEnterpriseInstall && enterpriseId === void 0)
            throw new Error("enterpriseId is required to fetch data of an enterprise installation");
          try {
            data = node_fs_1$1.default.readFileSync(
              node_path_1$1.default.resolve("".concat(installationDir, "/app-latest")),
            );
            installation = JSON.parse(data.toString());
            if (query.userId && installation.user.id !== query.userId)
              try {
                userData = node_fs_1$1.default.readFileSync(
                  node_path_1$1.default.resolve(
                    "".concat(installationDir, "/user-").concat(query.userId, "-latest"),
                  ),
                );
                ...
                logger === null ||
                  logger === void 0 ||
                  logger.debug(
                    "The user-token installation for the request user (user_id: ".concat(
                      query.userId,
                      ") was not found.",
                    ),
                  );
            ...
            throw new Error(
              "No installation data found (enterprise_id: "
                .concat(query.enterpriseId, ", team_id: ")
                .concat(query.teamId, ", user_id: ")
                .concat(query.userId, ")"),
            );
          }
          return [2];
        ...
        return __generator(this, function (_a) {
          ...
          try {
            for (_i = 0, filesToDelete_1 = filesToDelete; _i < filesToDelete_1.length; _i++) {
              ...
              deleteFile(
                node_path_1$1.default.resolve("".concat(installationDir, "/").concat(filePath)),
              );
            }
          } catch (err) {
            throw new Error(
              "Failed to delete installation from FileInstallationStore (error: ".concat(err, ")"),
            );
          }
          return [2];
        });
    ...
    FileInstallationStore.prototype.getInstallationDir = function (
      enterpriseId,
      teamId,
      isEnterpriseInstall,
    ) {
    ...
    MemoryInstallationStore.prototype.storeInstallation = function (installation, logger) {
      return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
          if (logger !== void 0)
            logger.warn(
              "Storing Access Token. Please use a real Installation Store for production!",
            );
    ...
    MemoryInstallationStore.prototype.fetchInstallation = function (query, logger) {
      return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
          if (logger !== void 0)
            logger.warn(
              "Retrieving Access Token from DB. Please use a real Installation Store for production!",
            );
    ...
    MemoryInstallationStore.prototype.deleteInstallation = function (query, logger) {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_e) {
          if (logger !== void 0)
            logger.warn(
              "Deleting Access Token from DB. Please use a real Installation Store for production!",
            );
          if (query.isEnterpriseInstall && query.enterpriseId !== void 0) {
            if (logger !== void 0) logger.debug("deleting org installation");
            ((_a = this.devDB),
              (_b = query.enterpriseId),
              _a[_b],
              (devDB = __rest(_a, [typeof _b === "symbol" ? _b : _b + ""])));
            this.devDB = devDB;
            ...
            ((_c = this.devDB),
              (_d = query.teamId),
              _c[_d],
              (devDB = __rest(_c, [typeof _d === "symbol" ? _d : _d + ""])));
            this.devDB = devDB;
      ...
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          try {
            ...
            message = "Failed to load the data represented by the state parameter (error: ".concat(
              e,
              ")",
            );
  ...
  exports.FileStateStore = (function () {
    function FileStateStore(args) {
      this.baseDir =
        args.baseDir !== void 0
          ? args.baseDir
          : "".concat((0, node_os_1.homedir)(), "/.bolt-js-oauth-states");
      this.stateExpirationSeconds =
        args.stateExpirationSeconds !== void 0 ? args.stateExpirationSeconds : 600;
        ...
        return __generator(this, function (_a) {
          try {
            ...
            try {
              ...
              message =
                "Failed to load the data represented by the state parameter (error: ".concat(
                  e,
                  ")",
                );
              throw new errors_1.InvalidStateError(message);
...
var require_install_provider = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  var default_render_html_for_install_path_1 = __importDefault(
    require_default_render_html_for_install_path(),
  );
  var errors_1 = require_errors$1();
  ...
  exports.InstallProvider = (function () {
    function InstallProvider(_a) {
      var clientId = _a.clientId,
        ...
        _b = _a.stateSecret,
        stateSecret = _b === void 0 ? void 0 : _b,
        _c = _a.stateStore,
        stateStore = _c === void 0 ? void 0 : _c,
        _d = _a.stateVerification,
        stateVerification = _d === void 0 ? true : _d,
        _e = _a.legacyStateVerification,
        legacyStateVerification = _e === void 0 ? false : _e,
        _f = _a.stateCookieName,
        stateCookieName = _f === void 0 ? "slack-app-oauth-state" : _f,
        _g = _a.stateCookieExpirationSeconds,
        stateCookieExpirationSeconds = _g === void 0 ? 600 : _g,
        _h = _a.directInstall,
        directInstall = _h === void 0 ? false : _h,
        _j = _a.installationStore,
        installationStore =
          _j === void 0 ? new installation_stores_1.MemoryInstallationStore() : _j,
        _k = _a.installUrlOptions,
        installUrlOptions = _k === void 0 ? void 0 : _k,
        _l = _a.renderHtmlForInstallPath,
        renderHtmlForInstallPath =
          _l === void 0 ? default_render_html_for_install_path_1.default : _l,
        _m = _a.authVersion,
        authVersion = _m === void 0 ? "v2" : _m,
        _o = _a.logger,
        logger = _o === void 0 ? void 0 : _o,
        _p = _a.logLevel,
        logLevel = _p === void 0 ? void 0 : _p,
        _q = _a.clientOptions,
        clientOptions = _q === void 0 ? {} : _q,
        _r = _a.authorizationUrl,
        authorizationUrl = _r === void 0 ? "https://slack.com/oauth/v2/authorize" : _r;
      if (clientId === void 0 || clientSecret === void 0)
        throw new errors_1.InstallerInitializationError(
          "You must provide a valid clientId and clientSecret",
        );
      if (typeof logger !== "undefined") {
        ...
        this.logger = (0, logger_1.getLogger)(
          ...
          logLevel !== null && logLevel !== void 0 ? logLevel : logger_1.LogLevel.INFO,
          logger,
        );
      ...
      if (stateStore !== void 0) this.stateStore = stateStore;
        ...
        if (stateSecret !== void 0)
          this.stateStore = new state_stores_1.ClearStateStore(
            stateSecret,
            this.stateCookieExpirationSeconds,
          );
        else
          throw new errors_1.InstallerInitializationError(
            "To use the built-in state store you must provide a State Secret",
          );
        ...
        return __generator(this, function (_e) {
          switch (_e.label) {
            ...
            case 1:
              ...
              this.logger.debug(
                "Starting authorize() execution (source: ".concat(sourceForLogging, ")"),
              );
            ...
            case 2:
              ...
              if (queryResult === void 0 || queryResult === null)
                throw new Error(
                  "Failed fetching data from the Installation Store (source: ".concat(
                    sourceForLogging,
                    ")",
                  ),
                );
              ...
              if (
                ((_b =
                  queryResult === null || queryResult === void 0
                    ? void 0
                    : queryResult.enterprise) === null || _b === void 0
                  ? void 0
                  : _b.id) ||
                (source === null || source === void 0 ? void 0 : source.enterpriseId)
              )
                authResult.enterpriseId =
                  ((_c =
                    queryResult === null || queryResult === void 0
                      ? void 0
                      : queryResult.enterprise) === null || _c === void 0
                    ? void 0
                    : _c.id) ||
                  (source === null || source === void 0 ? void 0 : source.enterpriseId);
              if (queryResult.bot) {
              ...
              if (queryResult.authVersion !== "v2") {
                errorMessage =
                  'Unexpected data structure detected. The data returned by your InstallationStore#fetchInstallation() method must have "authVersion": "v2" if it has a refresh token';
              ...
              for (
                ...
                if (botOrUser !== void 0) {
                  this.logger.debug(
                    "Saving ".concat(
                      tokenType,
                      " token and its refresh token in InstallationStore",
                    ),
                  );
                  ...
                  errorMessage =
                    "Unexpected data structure detected. The data returned by your InstallationStore#fetchInstallation() method must have ".concat(
                      tokenType,
                      " at top-level",
                    );
                  throw new errors_1.UnknownError(errorMessage);
            ...
            case 8:
              this.logger.debug(
                "Completed authorize() execution (source: ".concat(sourceForLogging, ")"),
              );
              return [7];
            case 9:
              return [2];
        ...
        return __generator(this, function (_a) {
          return [
            ...
            this.noTokenClient.oauth.v2
              ...
              .catch(function (e) {
                _this.logger.error(
                  "Failed to perform oauth.v2.access API call for token rotation: (error: ".concat(
                    e,
                    ")",
                  ),
                );
          ...
          switch (_a.label) {
            case 0:
              if (installOptions === void 0 && this.installUrlOptions === void 0) {
                errorMessage =
                  "To enable the built-in install path handler, you need to pass InstallURLOptions to InstallProvider. If you're using @slack/bolt, please upgrade the framework to the latest version.";
            ...
            case 1:
              ...
              if (
                !(
                  (options === null || options === void 0 ? void 0 : options.beforeRedirection) !==
                  void 0
                )
              )
                return [3, 3];
            ...
            case 3:
              if (!shouldProceed) {
                this.logger.debug(
                  "Skipped to proceed with the built-in redirection as beforeRedirection returned false",
                );
                return [2];
              }
              state = void 0;
              ...
              return [
                4,
                this.stateStore.generateStateParam(_installOptions, /* @__PURE__ */ new Date()),
              ];
            case 4:
              state = _a.sent();
            ...
            case 5:
              ...
              _a.label = 6;
            case 6:
              return [4, this.generateInstallUrl(_installOptions, this.stateVerification, state)];
            case 7:
              url = _a.sent();
            ...
            case 8:
              e_1 = _a.sent();
              message =
                "An unhandled error occurred while processing an install path request (error: ".concat(
                  e_1,
                  ")",
                );
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              if (options.scopes === void 0 || options.scopes === null)
        ...
        return __generator(this, function (_b) {
          switch (_b.label) {
            ...
            case 1:
              ...
              return [
                4,
                this.stateStore.verifyStateParam(/* @__PURE__ */ new Date(), stateInQueryString),
              ];
            case 2:
            ...
            case 3:
              throw new errors_1.InstallerInitializationError(
                "StateStore is not properly configured",
              );
            case 4:
              return [3, 6];
            case 5:
            ...
            case 6:
              ...
              if (
                !(
                  (options === null || options === void 0 ? void 0 : options.beforeInstallation) !==
                  void 0
                )
              )
                return [3, 8];
            ...
            case 13:
              ...
              v2Installation = {
                ...
                user: {
                  ...
                  scopes:
                    (_a = v2Resp.authed_user.scope) === null || _a === void 0
                      ? void 0
                      : _a.split(","),
              ...
              if (
                !(
                  v2Resp.access_token !== void 0 &&
                  v2Resp.scope !== void 0 &&
                  v2Resp.bot_user_id !== void 0
                )
              )
                return [3, 15];
            ...
            case 15:
              if (!(v2Resp.authed_user !== void 0 && v2Resp.authed_user.access_token !== void 0))
                return [3, 18];
              if (!(v2Resp.is_enterprise_install && v2Installation.enterpriseUrl === void 0))
                return [3, 17];
            ...
            case 17:
              if (
                v2Resp.authed_user.refresh_token !== void 0 &&
                v2Resp.authed_user.expires_in !== void 0
              ) {
            ...
            case 18:
              ...
              _b.label = 19;
            case 19:
              if (resp.incoming_webhook !== void 0)
              ...
              if (installOptions && installOptions.metadata !== void 0)
                installation.metadata = installOptions.metadata;
              if (
                !(
                  (options === null || options === void 0 ? void 0 : options.afterInstallation) !==
                  void 0
                )
              )
                return [3, 21];
            ...
            case 22:
              ...
              if (
                !(
                  options !== void 0 &&
                  (options.success !== void 0 || options.successAsync !== void 0)
                )
              )
                return [3, 25];
            ...
            case 25:
              ...
              (0, callback_options_1.defaultCallbackSuccess)(
                installation,
                installOptions,
                req,
                res,
            ...
            case 27:
              ...
              if (
                !(
                  options !== void 0 &&
                  (options.failure !== void 0 || options.failureAsync !== void 0)
                )
              )
                return [3, 30];
    ...
    InstallProvider.prototype.buildSetCookieHeaderForNewState = function (state) {
      ...
      return ""
        .concat(name, "=")
        .concat(state, "; Secure; HttpOnly; Path=/; Max-Age=")
        .concat(maxAge);
    };
    InstallProvider.prototype.buildSetCookieHeaderForStateDeletion = function () {
      ...
      return "".concat(
        name,
        "=deleted; Secure; HttpOnly; Path=/; Expires=Thu, 01 Jan 1970 00:00:00 GMT",
      );
    };
  ...
  function detectExpiredOrExpiringTokens(authResult, currentUTCSec) {
    ...
    if (
      ...
      authResult.botTokenExpiresAt !== void 0 &&
      authResult.botTokenExpiresAt !== null
    ) {
      if (authResult.botTokenExpiresAt - currentUTCSec <= EXPIRY_WINDOW)
        tokensToRefresh.push(authResult.botRefreshToken);
    }
    if (
      authResult.userRefreshToken &&
      authResult.userTokenExpiresAt !== void 0 &&
      authResult.userTokenExpiresAt !== null
    ) {
      if (authResult.userTokenExpiresAt - currentUTCSec <= EXPIRY_WINDOW)
...
var require_dist$3 = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  var __exportStar =
    ...
    function (m, exports$8) {
      for (var p in m)
        if (p !== "default" && !Object.prototype.hasOwnProperty.call(exports$8, p))
  ...
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.LogLevel =
    exports.defaultRenderHtmlForInstallPath =
    exports.defaultCallbackSuccess =
    exports.defaultCallbackFailure =
    exports.InstallProvider =
      void 0;
...
var require_dist$2 = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  function compile(path, options = {}) {
    ...
    const fn = tokensToFunction(
      (typeof path === "object" ? path : parse(path, options)).tokens,
      delimiter,
      encode,
    );
...
var require_depd = /* @__PURE__ */ __commonJSMin((exports, module) => {
  ...
  function formatPlain(msg, caller, stack) {
    var formatted =
      /* @__PURE__ */ new Date().toUTCString() + " " + this._namespace + " deprecated " + msg;
    if (this._traced) {
...
var require_setprototypeof = /* @__PURE__ */ __commonJSMin((exports, module) => {
  ...
  function mixinProperties(obj, proto) {
    for (var prop in proto)
      if (!Object.prototype.hasOwnProperty.call(obj, prop)) obj[prop] = proto[prop];
    return obj;
  }
});
//#endregion
...
var require_sbcs_data = /* @__PURE__ */ __commonJSMin((exports, module) => {
  module.exports = {
    ...
    maccenteuro: {
      type: "_sbcs",
      chars:
        "ÄĀāÉĄÖÜáąČäčĆćéŹźĎíďĒēĖóėôöõúĚěü†°Ę£§•¶ß®©™ę¨≠ģĮįĪ≤≥īĶ∂∑łĻļĽľĹĺŅņŃ¬√ńŇ∆«»…\xA0ňŐÕőŌ–—“”‘’÷◊ōŔŕŘ‹›řŖŗŠ‚„šŚśÁŤťÍŽžŪÓÔūŮÚůŰűŲųÝýķŻŁżĢˇ",
    },
    808: "cp808",
    ibm808: "cp808",
    cp808: {
      type: "_sbcs",
      chars:
        "АБВГДЕЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯабвгдежзийклмноп░▒▓│┤╡╢╖╕╣║╗╝╜╛┐└┴┬├─┼╞╟╚╔╩╦╠═╬╧╨╤╥╙╘╒╓╫╪┘┌█▄▌▐▀рстуфхцчшщъыьэюяЁёЄєЇїЎў°∙·√№€■\xA0",
    },
    mik: {
      type: "_sbcs",
      chars:
        "АБВГДЕЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯабвгдежзийклмнопрстуфхцчшщъыьэюя└┴┬├─┼╣║╚╔╩╦╠═╬┐░▒▓│┤№§╗╝┘┌█▄▌▐▀αßΓπΣσµτΦΘΩδ∞φε∩≡±≥≤⌠⌡÷≈°∙·√ⁿ²■\xA0",
    },
    cp720: {
      type: "_sbcs",
      chars:
        "éâàçêëèïîّْô¤ـûùءآأؤ£إئابةتثجحخدذرزسشص«»░▒▓│┤╡╢╖╕╣║╗╝╜╛┐└┴┬├─┼╞╟╚╔╩╦╠═╬╧╨╤╥╙╘╒╓╫╪┘┌█▄▌▐▀ضطظعغفµقكلمنهوىي≡ًٌٍَُِ≈°∙·√ⁿ²■\xA0",
    },
    ascii8bit: "ascii",
    usascii: "ascii",
    ansix34: "ascii",
...
var require_sbcs_data_generated = /* @__PURE__ */ __commonJSMin((exports, module) => {
  module.exports = {
    ...
    windows1250: {
      type: "_sbcs",
      chars:
        "€�‚�„…†‡�‰Š‹ŚŤŽŹ�‘’“”•–—�™š›śťžź\xA0ˇ˘Ł¤Ą¦§¨©Ş«¬­®Ż°±˛ł´µ¶·¸ąş»Ľ˝ľżŔÁÂĂÄĹĆÇČÉĘËĚÍÎĎĐŃŇÓÔŐÖ×ŘŮÚŰÜÝŢßŕáâăäĺćçčéęëěíîďđńňóôőö÷řůúűüýţ˙",
    },
    win1250: "windows1250",
    cp1250: "windows1250",
    windows1251: {
      type: "_sbcs",
      chars:
        "ЂЃ‚ѓ„…†‡€‰Љ‹ЊЌЋЏђ‘’“”•–—�™љ›њќћџ\xA0ЎўЈ¤Ґ¦§Ё©Є«¬­®Ї°±Ііґµ¶·ё№є»јЅѕїАБВГДЕЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯабвгдежзийклмнопрстуфхцчшщъыьэюя",
    },
    win1251: "windows1251",
    cp1251: "windows1251",
    windows1252: {
      type: "_sbcs",
      chars:
        "€�‚ƒ„…†‡ˆ‰Š‹Œ�Ž��‘’“”•–—˜™š›œ�žŸ\xA0¡¢£¤¥¦§¨©ª«¬­®¯°±²³´µ¶·¸¹º»¼½¾¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖ×ØÙÚÛÜÝÞßàáâãäåæçèéêëìíîïðñòóôõö÷øùúûüýþÿ",
    },
    win1252: "windows1252",
    cp1252: "windows1252",
    windows1253: {
      type: "_sbcs",
      chars:
        "€�‚ƒ„…†‡�‰�‹�����‘’“”•–—�™�›����\xA0΅Ά£¤¥¦§¨©�«¬­®―°±²³΄µ¶·ΈΉΊ»Ό½ΎΏΐΑΒΓΔΕΖΗΘΙΚΛΜΝΞΟΠΡ�ΣΤΥΦΧΨΩΪΫάέήίΰαβγδεζηθικλμνξοπρςστυφχψωϊϋόύώ�",
    },
    win1253: "windows1253",
    cp1253: "windows1253",
    windows1254: {
      type: "_sbcs",
      chars:
        "€�‚ƒ„…†‡ˆ‰Š‹Œ����‘’“”•–—˜™š›œ��Ÿ\xA0¡¢£¤¥¦§¨©ª«¬­®¯°±²³´µ¶·¸¹º»¼½¾¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏĞÑÒÓÔÕÖ×ØÙÚÛÜİŞßàáâãäåæçèéêëìíîïğñòóôõö÷øùúûüışÿ",
    },
    win1254: "windows1254",
    cp1254: "windows1254",
    windows1255: {
      type: "_sbcs",
      chars:
        "€�‚ƒ„…†‡ˆ‰�‹�����‘’“”•–—˜™�›����\xA0¡¢£₪¥¦§¨©×«¬­®¯°±²³´µ¶·¸¹÷»¼½¾¿ְֱֲֳִֵֶַָֹֺֻּֽ־ֿ׀ׁׂ׃װױײ׳״�������אבגדהוזחטיךכלםמןנסעףפץצקרשת��‎‏�",
    },
    win1255: "windows1255",
    cp1255: "windows1255",
    windows1256: {
      type: "_sbcs",
      chars:
        "€پ‚ƒ„…†‡ˆ‰ٹ‹Œچژڈگ‘’“”•–—ک™ڑ›œ‌‍ں\xA0،¢£¤¥¦§¨©ھ«¬­®¯°±²³´µ¶·¸¹؛»¼½¾؟ہءآأؤإئابةتثجحخدذرزسشصض×طظعغـفقكàلâمنهوçèéêëىيîïًٌٍَôُِ÷ّùْûü‎‏ے",
    },
    win1256: "windows1256",
    cp1256: "windows1256",
    windows1257: {
      type: "_sbcs",
      chars:
        "€�‚�„…†‡�‰�‹�¨ˇ¸�‘’“”•–—�™�›�¯˛�\xA0�¢£¤�¦§Ø©Ŗ«¬­®Æ°±²³´µ¶·ø¹ŗ»¼½¾æĄĮĀĆÄÅĘĒČÉŹĖĢĶĪĻŠŃŅÓŌÕÖ×ŲŁŚŪÜŻŽßąįāćäåęēčéźėģķīļšńņóōõö÷ųłśūüżž˙",
    },
    win1257: "windows1257",
    cp1257: "windows1257",
    windows1258: {
      type: "_sbcs",
      chars:
        "€�‚ƒ„…†‡ˆ‰�‹Œ����‘’“”•–—˜™�›œ��Ÿ\xA0¡¢£¤¥¦§¨©ª«¬­®¯°±²³´µ¶·¸¹º»¼½¾¿ÀÁÂĂÄÅÆÇÈÉÊË̀ÍÎÏĐÑ̉ÓÔƠÖ×ØÙÚÛÜỮßàáâăäåæçèéêë́íîïđṇ̃óôơö÷øùúûüư₫ÿ",
    },
    win1258: "windows1258",
    cp1258: "windows1258",
    iso88591: {
      type: "_sbcs",
      chars:
        "\xA0¡¢£¤¥¦§¨©ª«¬­®¯°±²³´µ¶·¸¹º»¼½¾¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖ×ØÙÚÛÜÝÞßàáâãäåæçèéêëìíîïðñòóôõö÷øùúûüýþÿ",
    },
    cp28591: "iso88591",
    iso88592: {
      type: "_sbcs",
      chars:
        "\xA0Ą˘Ł¤ĽŚ§¨ŠŞŤŹ­ŽŻ°ą˛ł´ľśˇ¸šşťź˝žżŔÁÂĂÄĹĆÇČÉĘËĚÍÎĎĐŃŇÓÔŐÖ×ŘŮÚŰÜÝŢßŕáâăäĺćçčéęëěíîďđńňóôőö÷řůúűüýţ˙",
    },
    cp28592: "iso88592",
    iso88593: {
      type: "_sbcs",
      chars:
        "\xA0Ħ˘£¤�Ĥ§¨İŞĞĴ­�Ż°ħ²³´µĥ·¸ışğĵ½�żÀÁÂ�ÄĊĈÇÈÉÊËÌÍÎÏ�ÑÒÓÔĠÖ×ĜÙÚÛÜŬŜßàáâ�äċĉçèéêëìíîï�ñòóôġö÷ĝùúûüŭŝ˙",
    },
    cp28593: "iso88593",
    iso88594: {
      type: "_sbcs",
      chars:
        "\xA0ĄĸŖ¤ĨĻ§¨ŠĒĢŦ­Ž¯°ą˛ŗ´ĩļˇ¸šēģŧŊžŋĀÁÂÃÄÅÆĮČÉĘËĖÍÎĪĐŅŌĶÔÕÖ×ØŲÚÛÜŨŪßāáâãäåæįčéęëėíîīđņōķôõö÷øųúûüũū˙",
    },
    cp28594: "iso88594",
    iso88595: {
      type: "_sbcs",
      chars:
        "\xA0ЁЂЃЄЅІЇЈЉЊЋЌ­ЎЏАБВГДЕЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯабвгдежзийклмнопрстуфхцчшщъыьэюя№ёђѓєѕіїјљњћќ§ўџ",
    },
    cp28595: "iso88595",
    iso88596: {
      type: "_sbcs",
      chars:
        "\xA0���¤�������،­�������������؛���؟�ءآأؤإئابةتثجحخدذرزسشصضطظعغ�����ـفقكلمنهوىيًٌٍَُِّْ�������������",
    },
    cp28596: "iso88596",
    iso88597: {
      type: "_sbcs",
      chars:
        "\xA0‘’£€₯¦§¨©ͺ«¬­�―°±²³΄΅Ά·ΈΉΊ»Ό½ΎΏΐΑΒΓΔΕΖΗΘΙΚΛΜΝΞΟΠΡ�ΣΤΥΦΧΨΩΪΫάέήίΰαβγδεζηθικλμνξοπρςστυφχψωϊϋόύώ�",
    },
    cp28597: "iso88597",
    iso88598: {
      type: "_sbcs",
      chars:
        "\xA0�¢£¤¥¦§¨©×«¬­®¯°±²³´µ¶·¸¹÷»¼½¾��������������������������������‗אבגדהוזחטיךכלםמןנסעףפץצקרשת��‎‏�",
    },
    cp28598: "iso88598",
    iso88599: {
      type: "_sbcs",
      chars:
        "\xA0¡¢£¤¥¦§¨©ª«¬­®¯°±²³´µ¶·¸¹º»¼½¾¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏĞÑÒÓÔÕÖ×ØÙÚÛÜİŞßàáâãäåæçèéêëìíîïğñòóôõö÷øùúûüışÿ",
    },
    cp28599: "iso88599",
    iso885910: {
      type: "_sbcs",
      chars:
        "\xA0ĄĒĢĪĨĶ§ĻĐŠŦŽ­ŪŊ°ąēģīĩķ·ļđšŧž―ūŋĀÁÂÃÄÅÆĮČÉĘËĖÍÎÏÐŅŌÓÔÕÖŨØŲÚÛÜÝÞßāáâãäåæįčéęëėíîïðņōóôõöũøųúûüýþĸ",
    },
    cp28600: "iso885910",
    iso885911: {
      type: "_sbcs",
    ...
    iso885913: {
      type: "_sbcs",
      chars:
        "\xA0”¢£¤„¦§Ø©Ŗ«¬­®Æ°±²³“µ¶·ø¹ŗ»¼½¾æĄĮĀĆÄÅĘĒČÉŹĖĢĶĪĻŠŃŅÓŌÕÖ×ŲŁŚŪÜŻŽßąįāćäåęēčéźėģķīļšńņóōõö÷ųłśūüżž’",
    },
    cp28603: "iso885913",
    iso885914: {
      type: "_sbcs",
      chars:
        "\xA0Ḃḃ£ĊċḊ§Ẁ©ẂḋỲ­®ŸḞḟĠġṀṁ¶ṖẁṗẃṠỳẄẅṡÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏŴÑÒÓÔÕÖṪØÙÚÛÜÝŶßàáâãäåæçèéêëìíîïŵñòóôõöṫøùúûüýŷÿ",
    },
    cp28604: "iso885914",
    iso885915: {
      type: "_sbcs",
      chars:
        "\xA0¡¢£€¥Š§š©ª«¬­®¯°±²³Žµ¶·ž¹º»ŒœŸ¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖ×ØÙÚÛÜÝÞßàáâãäåæçèéêëìíîïðñòóôõö÷øùúûüýþÿ",
    },
    cp28605: "iso885915",
    iso885916: {
      type: "_sbcs",
      chars:
        "\xA0ĄąŁ€„Š§š©Ș«Ź­źŻ°±ČłŽ”¶·žčș»ŒœŸżÀÁÂĂÄĆÆÇÈÉÊËÌÍÎÏĐŃÒÓÔŐÖŚŰÙÚÛÜĘȚßàáâăäćæçèéêëìíîïđńòóôőöśűùúûüęțÿ",
    },
    cp28606: "iso885916",
    cp437: {
      type: "_sbcs",
    ...
    cp737: {
      type: "_sbcs",
      chars:
        "ΑΒΓΔΕΖΗΘΙΚΛΜΝΞΟΠΡΣΤΥΦΧΨΩαβγδεζηθικλμνξοπρσςτυφχψ░▒▓│┤╡╢╖╕╣║╗╝╜╛┐└┴┬├─┼╞╟╚╔╩╦╠═╬╧╨╤╥╙╘╒╓╫╪┘┌█▄▌▐▀ωάέήϊίόύϋώΆΈΉΊΌΎΏ±≥≤ΪΫ÷≈°∙·√ⁿ²■\xA0",
    },
    ibm737: "cp737",
    csibm737: "cp737",
    cp775: {
      type: "_sbcs",
      chars:
        "ĆüéāäģåćłēŖŗīŹÄÅÉæÆōöĢ¢ŚśÖÜø£Ø×¤ĀĪóŻżź”¦©®¬½¼Ł«»░▒▓│┤ĄČĘĖ╣║╗╝ĮŠ┐└┴┬├─┼ŲŪ╚╔╩╦╠═╬Žąčęėįšųūž┘┌█▄▌▐▀ÓßŌŃõÕµńĶķĻļņĒŅ’­±“¾¶§÷„°∙·¹³²■\xA0",
    },
    ibm775: "cp775",
    csibm775: "cp775",
    cp850: {
      type: "_sbcs",
      chars:
        "ÇüéâäàåçêëèïîìÄÅÉæÆôöòûùÿÖÜø£Ø×ƒáíóúñÑªº¿®¬½¼¡«»░▒▓│┤ÁÂÀ©╣║╗╝¢¥┐└┴┬├─┼ãÃ╚╔╩╦╠═╬¤ðÐÊËÈıÍÎÏ┘┌█▄¦Ì▀ÓßÔÒõÕµþÞÚÛÙýÝ¯´­±‗¾¶§÷¸°¨·¹³²■\xA0",
    },
    ibm850: "cp850",
    csibm850: "cp850",
    cp852: {
      type: "_sbcs",
      chars:
        "ÇüéâäůćçłëŐőîŹÄĆÉĹĺôöĽľŚśÖÜŤťŁ×čáíóúĄąŽžĘę¬źČş«»░▒▓│┤ÁÂĚŞ╣║╗╝Żż┐└┴┬├─┼Ăă╚╔╩╦╠═╬¤đĐĎËďŇÍÎě┘┌█▄ŢŮ▀ÓßÔŃńňŠšŔÚŕŰýÝţ´­˝˛ˇ˘§÷¸°¨˙űŘř■\xA0",
    },
    ibm852: "cp852",
    csibm852: "cp852",
    cp855: {
      type: "_sbcs",
      chars:
        "ђЂѓЃёЁєЄѕЅіІїЇјЈљЉњЊћЋќЌўЎџЏюЮъЪаАбБцЦдДеЕфФгГ«»░▒▓│┤хХиИ╣║╗╝йЙ┐└┴┬├─┼кК╚╔╩╦╠═╬¤лЛмМнНоОп┘┌█▄Пя▀ЯрРсСтТуУжЖвВьЬ№­ыЫзЗшШэЭщЩчЧ§■\xA0",
    },
    ibm855: "cp855",
    csibm855: "cp855",
    cp856: {
      type: "_sbcs",
      chars:
        "אבגדהוזחטיךכלםמןנסעףפץצקרשת�£�×����������®¬½¼�«»░▒▓│┤���©╣║╗╝¢¥┐└┴┬├─┼��╚╔╩╦╠═╬¤���������┘┌█▄¦�▀������µ�������¯´­±‗¾¶§÷¸°¨·¹³²■\xA0",
    },
    ibm856: "cp856",
    csibm856: "cp856",
    cp857: {
      type: "_sbcs",
      chars:
        "ÇüéâäàåçêëèïîıÄÅÉæÆôöòûùİÖÜø£ØŞşáíóúñÑĞğ¿®¬½¼¡«»░▒▓│┤ÁÂÀ©╣║╗╝¢¥┐└┴┬├─┼ãÃ╚╔╩╦╠═╬¤ºªÊËÈ�ÍÎÏ┘┌█▄¦Ì▀ÓßÔÒõÕµ�×ÚÛÙìÿ¯´­±�¾¶§÷¸°¨·¹³²■\xA0",
    },
    ibm857: "cp857",
    csibm857: "cp857",
    cp858: {
      type: "_sbcs",
      chars:
        "ÇüéâäàåçêëèïîìÄÅÉæÆôöòûùÿÖÜø£Ø×ƒáíóúñÑªº¿®¬½¼¡«»░▒▓│┤ÁÂÀ©╣║╗╝¢¥┐└┴┬├─┼ãÃ╚╔╩╦╠═╬¤ðÐÊËÈ€ÍÎÏ┘┌█▄¦Ì▀ÓßÔÒõÕµþÞÚÛÙýÝ¯´­±‗¾¶§÷¸°¨·¹³²■\xA0",
    },
    ibm858: "cp858",
    csibm858: "cp858",
    cp860: {
      type: "_sbcs",
      chars:
        "ÇüéâãàÁçêÊèÍÔìÃÂÉÀÈôõòÚùÌÕÜ¢£Ù₧ÓáíóúñÑªº¿Ò¬½¼¡«»░▒▓│┤╡╢╖╕╣║╗╝╜╛┐└┴┬├─┼╞╟╚╔╩╦╠═╬╧╨╤╥╙╘╒╓╫╪┘┌█▄▌▐▀αßΓπΣσµτΦΘΩδ∞φε∩≡±≥≤⌠⌡÷≈°∙·√ⁿ²■\xA0",
    },
    ibm860: "cp860",
    csibm860: "cp860",
    cp861: {
      type: "_sbcs",
      chars:
        "ÇüéâäàåçêëèÐðÞÄÅÉæÆôöþûÝýÖÜø£Ø₧ƒáíóúÁÍÓÚ¿⌐¬½¼¡«»░▒▓│┤╡╢╖╕╣║╗╝╜╛┐└┴┬├─┼╞╟╚╔╩╦╠═╬╧╨╤╥╙╘╒╓╫╪┘┌█▄▌▐▀αßΓπΣσµτΦΘΩδ∞φε∩≡±≥≤⌠⌡÷≈°∙·√ⁿ²■\xA0",
    },
    ibm861: "cp861",
    csibm861: "cp861",
    cp862: {
      type: "_sbcs",
      chars:
        "אבגדהוזחטיךכלםמןנסעףפץצקרשת¢£¥₧ƒáíóúñÑªº¿⌐¬½¼¡«»░▒▓│┤╡╢╖╕╣║╗╝╜╛┐└┴┬├─┼╞╟╚╔╩╦╠═╬╧╨╤╥╙╘╒╓╫╪┘┌█▄▌▐▀αßΓπΣσµτΦΘΩδ∞φε∩≡±≥≤⌠⌡÷≈°∙·√ⁿ²■\xA0",
    },
    ibm862: "cp862",
    csibm862: "cp862",
    cp863: {
      type: "_sbcs",
      chars:
        "ÇüéâÂà¶çêëèïî‗À§ÉÈÊôËÏûù¤ÔÜ¢£ÙÛƒ¦´óú¨¸³¯Î⌐¬½¼¾«»░▒▓│┤╡╢╖╕╣║╗╝╜╛┐└┴┬├─┼╞╟╚╔╩╦╠═╬╧╨╤╥╙╘╒╓╫╪┘┌█▄▌▐▀αßΓπΣσµτΦΘΩδ∞φε∩≡±≥≤⌠⌡÷≈°∙·√ⁿ²■\xA0",
    },
    ibm863: "cp863",
    csibm863: "cp863",
    cp864: {
    ...
    cp865: {
      type: "_sbcs",
      chars:
        "ÇüéâäàåçêëèïîìÄÅÉæÆôöòûùÿÖÜø£Ø₧ƒáíóúñÑªº¿⌐¬½¼¡«¤░▒▓│┤╡╢╖╕╣║╗╝╜╛┐└┴┬├─┼╞╟╚╔╩╦╠═╬╧╨╤╥╙╘╒╓╫╪┘┌█▄▌▐▀αßΓπΣσµτΦΘΩδ∞φε∩≡±≥≤⌠⌡÷≈°∙·√ⁿ²■\xA0",
    },
    ibm865: "cp865",
    csibm865: "cp865",
    cp866: {
    ...
    cp869: {
      type: "_sbcs",
      chars:
        "������Ά�·¬¦‘’Έ―ΉΊΪΌ��ΎΫ©Ώ²³ά£έήίϊΐόύΑΒΓΔΕΖΗ½ΘΙ«»░▒▓│┤ΚΛΜΝ╣║╗╝ΞΟ┐└┴┬├─┼ΠΡ╚╔╩╦╠═╬ΣΤΥΦΧΨΩαβγ┘┌█▄δε▀ζηθικλμνξοπρσςτ΄­±υφχ§ψ΅°¨ωϋΰώ■\xA0",
    },
    ibm869: "cp869",
    csibm869: "cp869",
    cp922: {
      type: "_sbcs",
      chars:
        "\xA0¡¢£¤¥¦§¨©ª«¬­®‾°±²³´µ¶·¸¹º»¼½¾¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏŠÑÒÓÔÕÖ×ØÙÚÛÜÝŽßàáâãäåæçèéêëìíîïšñòóôõö÷øùúûüýžÿ",
    },
    ibm922: "cp922",
    csibm922: "cp922",
    cp1046: {
      type: "_sbcs",
      chars:
        "ﺈ×÷ﹱ■│─┐┌└┘ﹹﹻﹽﹿﹷﺊﻰﻳﻲﻎﻏﻐﻶﻸﻺﻼ\xA0¤ﺋﺑﺗﺛﺟﺣ،­ﺧﺳ٠١٢٣٤٥٦٧٨٩ﺷ؛ﺻﺿﻊ؟ﻋءآأؤإئابةتثجحخدذرزسشصضطﻇعغﻌﺂﺄﺎﻓـفقكلمنهوىيًٌٍَُِّْﻗﻛﻟﻵﻷﻹﻻﻣﻧﻬﻩ�",
    },
    ibm1046: "cp1046",
    csibm1046: "cp1046",
    cp1124: {
      type: "_sbcs",
      chars:
        "\xA0ЁЂҐЄЅІЇЈЉЊЋЌ­ЎЏАБВГДЕЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯабвгдежзийклмнопрстуфхцчшщъыьэюя№ёђґєѕіїјљњћќ§ўџ",
    },
    ibm1124: "cp1124",
    csibm1124: "cp1124",
    cp1125: {
      type: "_sbcs",
      chars:
        "АБВГДЕЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯабвгдежзийклмноп░▒▓│┤╡╢╖╕╣║╗╝╜╛┐└┴┬├─┼╞╟╚╔╩╦╠═╬╧╨╤╥╙╘╒╓╫╪┘┌█▄▌▐▀рстуфхцчшщъыьэюяЁёҐґЄєІіЇї·√№¤■\xA0",
    },
    ibm1125: "cp1125",
    csibm1125: "cp1125",
    cp1129: {
      type: "_sbcs",
      chars:
        "\xA0¡¢£¤¥¦§œ©ª«¬­®¯°±²³Ÿµ¶·Œ¹º»¼½¾¿ÀÁÂĂÄÅÆÇÈÉÊË̀ÍÎÏĐÑ̉ÓÔƠÖ×ØÙÚÛÜỮßàáâăäåæçèéêë́íîïđṇ̃óôơö÷øùúûüư₫ÿ",
    },
    ibm1129: "cp1129",
    csibm1129: "cp1129",
    cp1133: {
      type: "_sbcs",
      chars:
        "\xA0ກຂຄງຈສຊຍດຕຖທນບປຜຝພຟມຢຣລວຫອຮ���ຯະາຳິີຶືຸູຼັົຽ���ເແໂໃໄ່້໊໋໌ໍໆ�ໜໝ₭����������������໐໑໒໓໔໕໖໗໘໙��¢¬¦�",
    },
    ibm1133: "cp1133",
    csibm1133: "cp1133",
    cp1161: {
      type: "_sbcs",
      chars:
        "��������������������������������่กขฃคฅฆงจฉชซฌญฎฏฐฑฒณดตถทธนบปผฝพฟภมยรฤลฦวศษสหฬอฮฯะัาำิีึืฺุู้๊๋€฿เแโใไๅๆ็่้๊๋์ํ๎๏๐๑๒๓๔๕๖๗๘๙๚๛¢¬¦\xA0",
    },
    ibm1161: "cp1161",
    csibm1161: "cp1161",
    cp1162: {
    ...
    maccroatian: {
      type: "_sbcs",
      chars:
        "ÄÅÇÉÑÖÜáàâäãåçéèêëíìîïñóòôöõúùûü†°¢£§•¶ß®Š™´¨≠ŽØ∞±≤≥∆µ∂∑∏š∫ªºΩžø¿¡¬√ƒ≈Ć«Č…\xA0ÀÃÕŒœĐ—“”‘’÷◊�©⁄¤‹›Æ»–·‚„‰ÂćÁčÈÍÎÏÌÓÔđÒÚÛÙıˆ˜¯πË˚¸Êæˇ",
    },
    maccyrillic: {
      type: "_sbcs",
      chars:
        "АБВГДЕЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯ†°¢£§•¶І®©™Ђђ≠Ѓѓ∞±≤≥іµ∂ЈЄєЇїЉљЊњјЅ¬√ƒ≈∆«»…\xA0ЋћЌќѕ–—“”‘’÷„ЎўЏџ№Ёёяабвгдежзийклмнопрстуфхцчшщъыьэю¤",
    },
    macgreek: {
      type: "_sbcs",
      chars:
        "Ä¹²É³ÖÜ΅àâä΄¨çéèêë£™îï•½‰ôö¦­ùûü†ΓΔΘΛΞΠß®©ΣΪ§≠°·Α±≤≥¥ΒΕΖΗΙΚΜΦΫΨΩάΝ¬ΟΡ≈Τ«»…\xA0ΥΧΆΈœ–―“”‘’÷ΉΊΌΎέήίόΏύαβψδεφγηιξκλμνοπώρστθωςχυζϊϋΐΰ�",
    },
    maciceland: {
      type: "_sbcs",
      chars:
        "ÄÅÇÉÑÖÜáàâäãåçéèêëíìîïñóòôöõúùûüÝ°¢£§•¶ß®©™´¨≠ÆØ∞±≤≥¥µ∂∑∏π∫ªºΩæø¿¡¬√ƒ≈∆«»…\xA0ÀÃÕŒœ–—“”‘’÷◊ÿŸ⁄¤ÐðÞþý·‚„‰ÂÊÁËÈÍÎÏÌÓÔ�ÒÚÛÙıˆ˜¯˘˙˚¸˝˛ˇ",
    },
    macroman: {
      type: "_sbcs",
      chars:
        "ÄÅÇÉÑÖÜáàâäãåçéèêëíìîïñóòôöõúùûü†°¢£§•¶ß®©™´¨≠ÆØ∞±≤≥¥µ∂∑∏π∫ªºΩæø¿¡¬√ƒ≈∆«»…\xA0ÀÃÕŒœ–—“”‘’÷◊ÿŸ⁄¤‹›ﬁﬂ‡·‚„‰ÂÊÁËÈÍÎÏÌÓÔ�ÒÚÛÙıˆ˜¯˘˙˚¸˝˛ˇ",
    },
    macromania: {
      type: "_sbcs",
      chars:
        "ÄÅÇÉÑÖÜáàâäãåçéèêëíìîïñóòôöõúùûü†°¢£§•¶ß®©™´¨≠ĂŞ∞±≤≥¥µ∂∑∏π∫ªºΩăş¿¡¬√ƒ≈∆«»…\xA0ÀÃÕŒœ–—“”‘’÷◊ÿŸ⁄¤‹›Ţţ‡·‚„‰ÂÊÁËÈÍÎÏÌÓÔ�ÒÚÛÙıˆ˜¯˘˙˚¸˝˛ˇ",
    },
    macthai: {
      type: "_sbcs",
      chars:
        "«»…“”�•‘’�\xA0กขฃคฅฆงจฉชซฌญฎฏฐฑฒณดตถทธนบปผฝพฟภมยรฤลฦวศษสหฬอฮฯะัาำิีึืฺุู﻿​–—฿เแโใไๅๆ็่้๊๋์ํ™๏๐๑๒๓๔๕๖๗๘๙®©����",
    },
    macturkish: {
      type: "_sbcs",
      chars:
        "ÄÅÇÉÑÖÜáàâäãåçéèêëíìîïñóòôöõúùûü†°¢£§•¶ß®©™´¨≠ÆØ∞±≤≥¥µ∂∑∏π∫ªºΩæø¿¡¬√ƒ≈∆«»…\xA0ÀÃÕŒœ–—“”‘’÷◊ÿŸĞğİıŞş‡·‚„‰ÂÊÁËÈÍÎÏÌÓÔ�ÒÚÛÙ�ˆ˜¯˘˙˚¸˝˛ˇ",
    },
    macukraine: {
      type: "_sbcs",
      chars:
        "АБВГДЕЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯ†°Ґ£§•¶І®©™Ђђ≠Ѓѓ∞±≤≥іµґЈЄєЇїЉљЊњјЅ¬√ƒ≈∆«»…\xA0ЋћЌќѕ–—“”‘’÷„ЎўЏџ№Ёёяабвгдежзийклмнопрстуфхцчшщъыьэю¤",
    },
    koi8r: {
      type: "_sbcs",
      chars:
        "─│┌┐└┘├┤┬┴┼▀▄█▌▐░▒▓⌠■∙√≈≤≥\xA0⌡°²·÷═║╒ё╓╔╕╖╗╘╙╚╛╜╝╞╟╠╡Ё╢╣╤╥╦╧╨╩╪╫╬©юабцдефгхийклмнопярстужвьызшэщчъЮАБЦДЕФГХИЙКЛМНОПЯРСТУЖВЬЫЗШЭЩЧЪ",
    },
    koi8u: {
      type: "_sbcs",
      chars:
        "─│┌┐└┘├┤┬┴┼▀▄█▌▐░▒▓⌠■∙√≈≤≥\xA0⌡°²·÷═║╒ёє╔ії╗╘╙╚╛ґ╝╞╟╠╡ЁЄ╣ІЇ╦╧╨╩╪Ґ╬©юабцдефгхийклмнопярстужвьызшэщчъЮАБЦДЕФГХИЙКЛМНОПЯРСТУЖВЬЫЗШЭЩЧЪ",
    },
    koi8ru: {
      type: "_sbcs",
      chars:
        "─│┌┐└┘├┤┬┴┼▀▄█▌▐░▒▓⌠■∙√≈≤≥\xA0⌡°²·÷═║╒ёє╔ії╗╘╙╚╛ґў╞╟╠╡ЁЄ╣ІЇ╦╧╨╩╪ҐЎ©юабцдефгхийклмнопярстужвьызшэщчъЮАБЦДЕФГХИЙКЛМНОПЯРСТУЖВЬЫЗШЭЩЧЪ",
    },
    koi8t: {
      type: "_sbcs",
      chars:
    ...
    armscii8: {
      type: "_sbcs",
      chars:
        "\xA0�և։)(»«—.՝,-֊…՜՛՞ԱաԲբԳգԴդԵեԶզԷէԸըԹթԺժԻիԼլԽխԾծԿկՀհՁձՂղՃճՄմՅյՆնՇշՈոՉչՊպՋջՌռՍսՎվՏտՐրՑցՒւՓփՔքՕօՖֆ՚�",
    },
    rk1048: {
      type: "_sbcs",
      chars:
        "ЂЃ‚ѓ„…†‡€‰Љ‹ЊҚҺЏђ‘’“”•–—�™љ›њқһџ\xA0ҰұӘ¤Ө¦§Ё©Ғ«¬­®Ү°±Ііөµ¶·ё№ғ»әҢңүАБВГДЕЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯабвгдежзийклмнопрстуфхцчшщъыьэюя",
    },
    tcvn: {
      type: "_sbcs",
      chars:
    ...
    georgianacademy: {
      type: "_sbcs",
      chars:
        "‚ƒ„…†‡ˆ‰Š‹Œ‘’“”•–—˜™š›œŸ\xA0¡¢£¤¥¦§¨©ª«¬­®¯°±²³´µ¶·¸¹º»¼½¾¿აბგდევზთიკლმნოპჟრსტუფქღყშჩცძწჭხჯჰჱჲჳჴჵჶçèéêëìíîïðñòóôõö÷øùúûüýþÿ",
    },
    georgianps: {
      type: "_sbcs",
      chars:
        "‚ƒ„…†‡ˆ‰Š‹Œ‘’“”•–—˜™š›œŸ\xA0¡¢£¤¥¦§¨©ª«¬­®¯°±²³´µ¶·¸¹º»¼½¾¿აბგდევზჱთიკლმნჲოპჟრსტჳუფქღყშჩცძწჭხჴჯჰჵæçèéêëìíîïðñòóôõö÷øùúûüýþÿ",
    },
    pt154: {
      type: "_sbcs",
      chars:
        "ҖҒӮғ„…ҶҮҲүҠӢҢҚҺҸҗ‘’“”•–—ҳҷҡӣңқһҹ\xA0ЎўЈӨҘҰ§Ё©Ә«¬ӯ®Ҝ°ұІіҙө¶·ё№ә»јҪҫҝАБВГДЕЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯабвгдежзийклмнопрстуфхцчшщъыьэюя",
    },
    viscii: {
      type: "_sbcs",
      chars:
    ...
    hproman8: {
      type: "_sbcs",
      chars:
        "\xA0ÀÂÈÊËÎÏ´ˋˆ¨˜ÙÛ₤¯Ýý°ÇçÑñ¡¿¤£¥§ƒ¢âêôûáéóúàèòùäëöüÅîØÆåíøæÄìÖÜÉïßÔÁÃãÐðÍÌÓÒÕõŠšÚŸÿÞþ·µ¶¾—¼½ªº«■»±�",
    },
    macintosh: {
      type: "_sbcs",
      chars:
      ...
      if (uCode >= 0) {
        ...
        if (i >= 3)
          ...
          var ptr =
            ...
            ((i - 2 >= 0 ? buf[i - 2] : prevBytes[i - 2 + prevOffset]) - 48) * 1260 +
            ((i - 1 >= 0 ? buf[i - 1] : prevBytes[i - 1 + prevOffset]) - 129) * 10 +
            (curByte - 48);
  ...
  module.exports = function (streamModule) {
    ...
    IconvLiteEncoderStream.prototype._transform = function (chunk, encoding, done) {
      if (typeof chunk !== "string")
        return done(/* @__PURE__ */ new Error("Iconv encoding stream needs strings as its input."));
      try {
    ...
    IconvLiteDecoderStream.prototype._transform = function (chunk, encoding, done) {
      if (!Buffer.isBuffer(chunk) && !(chunk instanceof Uint8Array))
        return done(/* @__PURE__ */ new Error("Iconv decoding stream needs buffers as its input."));
      try {
        var res = this.conv.write(chunk);
...
var require_raw_body = /* @__PURE__ */ __commonJSMin((exports, module) => {
  ...
  function readStream(stream, encoding, length, limit, callback) {
    ...
    if (stream._decoder || (state && (state.encoding || state.decoder)))
      return done(
        createError(500, "stream encoding should not be set", { type: "stream.encoding.set" }),
      );
    if (typeof stream.readable !== "undefined" && !stream.readable)
      return done(createError(500, "stream is not readable", { type: "stream.not.readable" }));
    var received = 0;
    var decoder;
    try {
...
var require_verify_request = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  function verifySlackRequest(options) {
    ...
    if (requestTimestampSec < Math.floor(nowMs / 1e3) - 60 * requestTimestampMaxDeltaMin)
      throw new Error(
...
var require_HTTPModuleFunctions = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.defaultUnhandledRequestHandler =
    exports.defaultProcessEventErrorHandler =
    exports.defaultAsyncDispatchErrorHandler =
    exports.defaultDispatchErrorHandler =
    exports.buildContentResponse =
    exports.buildSSLCheckResponse =
    exports.buildUrlVerificationResponse =
    exports.buildNoBodyResponse =
    exports.bufferIncomingMessage =
    exports.getHeader =
    exports.isBufferedIncomingMessage =
    exports.parseAndVerifyHTTPRequest =
    exports.parseHTTPRequestBody =
    exports.extractRetryReasonFromHTTPRequest =
    exports.extractRetryNumFromHTTPRequest =
      void 0;
  ...
  const defaultDispatchErrorHandler = (args) => {
    ...
    logger.error(
      `An unexpected error occurred during a request (${request.method}) made to ${request.url}`,
    );
  ...
  var HTTPResponseAck = class {
    ...
    constructor(args) {
      ...
      this.unhandledRequestHandler =
        args.unhandledRequestHandler ?? httpFunc.defaultUnhandledRequestHandler;
  ...
  function validateCustomRoutes(customRoutes) {
    ...
    for (const route of customRoutes)
      for (const key of requiredKeys)
        if (route[key] === void 0 && !missingKeys.includes(key)) missingKeys.push(key);
  ...
  function verifyRedirectOpts({ redirectUri, redirectUriPath }) {
    if (redirectUri && !redirectUriPath)
      throw new errors_1.AppInitializationError(
        " You have set a redirectUri but not a matching redirectUriPath. Please provide this via installerOptions.redirectUriPath Note: These should be consistent, e.g. https://example.com/redirect and /redirect",
      );
    if (redirectUri && redirectUriPath && !redirectUri?.endsWith(redirectUriPath))
      throw new errors_1.AppInitializationError(
        "redirectUri and installerOptions.redirectUriPath should be consistent e.g. https://example.com/redirect and /redirect",
      );
  }
  ...
  var HTTPReceiver = class {
    ...
    constructor({
      ...
      if (
        ...
        (this.stateVerification === false ||
          stateSecret !== void 0 ||
          installerOptions.stateStore !== void 0)
      ) {
    ...
    start(portOrListenOptions, serverOptions = {}) {
      ...
      if (Object.keys(serverOptions).filter((k) => httpsOptionKeys.includes(k)).length > 0)
        createServerFn = node_https_1$1.createServer;
      if (this.server !== void 0)
        return Promise.reject(
          new errors_1.ReceiverInconsistentStateError(
      ...
      return new Promise((resolve, reject) => {
        ...
        this.server.listen(listenOptions, () => {
          if (this.server === void 0)
            return reject(
              new errors_1.ReceiverInconsistentStateError(missingServerErrorDescription),
            );
    ...
    unboundRequestListener(req, res) {
      ...
      throw new errors_1.HTTPReceiverDeferredRequestError(
        `Unhandled HTTP request (${method}) made to ${path}`,
        req,
        res,
      );
    }
    handleIncomingEvent(req, res) {
      (async () => {
        ...
        try {
          ...
          if (
            await this.processEventErrorHandler({
              error,
              logger: this.logger,
              request: req,
              response: res,
    ...
    handleInstallRedirectRequest(req, res) {
      ...
      if (this.stateVerification === false)
        installer
          .handleCallback(req, res, installCallbackOptions, installUrlOptions)
          .catch(errorHandler);
...
var require_errors = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  function platformErrorFromEvent(event) {
    const error = errorWithCode(
      /* @__PURE__ */ new Error(`An API error occurred: ${event.error.msg}`),
  ...
  function sendWhileNotReadyError() {
    return errorWithCode(
      /* @__PURE__ */ new Error("Failed to send a WebSocket message as the client is not ready"),
      ErrorCode.NoReplyReceivedError,
    );
  }
});
...
var require_SlackWebSocket = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  var SlackWebSocket = class SlackWebSocket {
    constructor({
      ...
      serverPingTimeoutMS = 3e4,
      clientPingTimeoutMS = 5e3,
    }) {
      this.options = {
        url,
        client,
    ...
    connect() {
      ...
      this.websocket.on("close", (code, data) => {
        this.logger.debug(
          `WebSocket close frame received (code: ${code}, reason: ${data.toString()})`,
        );
    ...
    isActive() {
      ...
      this.logger.debug(
        `isActive(): websocket ready state is ${exports.WS_READY_STATES[this.websocket.readyState]}`,
      );
    ...
    monitorPingToSlack() {
      ...
      this.clientPingTimeout = setInterval(() => {
        ...
        if (this.lastPongReceivedTimestamp !== void 0)
          isInvalid = now - this.lastPongReceivedTimestamp > this.options.clientPingTimeoutMS;
        if (isInvalid) {
          this.logger.warn(
...
var require_UnrecoverableSocketModeStartError = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  (function (UnrecoverableSocketModeStartError) {
    ...
    UnrecoverableSocketModeStartError ||
      (exports.UnrecoverableSocketModeStartError = UnrecoverableSocketModeStartError = {}),
  );
});
//#endregion
...
var require_SocketModeClient = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  var SocketModeClient = class SocketModeClient extends eventemitter3_1.EventEmitter {
    constructor(
      {
        ...
        pingPongLoggingEnabled = false,
        clientPingTimeout = 5e3,
        serverPingTimeout = 3e4,
        appToken = "",
        clientOptions = {},
      } = { appToken: "" },
    ) {
      ...
      if (typeof logger !== "undefined") {
        ...
        this.logger = logger_1.default.getLogger(
          SocketModeClient.loggerName,
          logLevel !== null && logLevel !== void 0 ? logLevel : logger_1.LogLevel.INFO,
          logger,
        );
      this.webClientOptions = clientOptions;
      if (this.webClientOptions.retryConfig === void 0)
        this.webClientOptions.retryConfig = {
          retries: 100,
          factor: 1.3,
        };
      this.webClient = new web_api_1.WebClient(
        "",
        Object.assign(
          {
            logger,
    ...
    delayReconnectAttempt(cb) {
      ...
      this.logger.debug(
        `Before trying to reconnect, this client will wait for ${msBeforeRetry} milliseconds`,
      );
    ...
    retrieveWSSURL() {
      return __awaiter(this, void 0, void 0, function* () {
        try {
          ...
          if (
            err.code === web_api_1.ErrorCode.PlatformError &&
            Object.values(
              UnrecoverableSocketModeStartError_1.UnrecoverableSocketModeStartError,
    ...
    send(id, body = {}) {
      ...
      return new Promise((resolve, reject) => {
        ...
        this.logger.debug(
          `send() method was called (WebSocket state: ${wsState ? SlackWebSocket_1.WS_READY_STATES[wsState] : "uninitialized"})`,
        );
...
var require_src = /* @__PURE__ */ __commonJSMin((exports) => {
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.UnrecoverableSocketModeStartError =
    exports.SocketModeClient =
    exports.LogLevel =
    exports.ErrorCode =
      void 0;
...
var require_SocketModeFunctions = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  async function defaultProcessEventErrorHandler(args) {
    ...
    logger.error(
      `An unhandled error occurred while Bolt processed (type: ${event.body?.type}, error: ${error})`,
    );
    logger.debug(
      `Error details: ${error}, retry num: ${event.retryNum}, retry reason: ${event.retryReason}`,
    );
...
var require_SocketModeReceiver = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  var SocketModeReceiver = class {
    ...
    constructor({
      ...
      processEventErrorHandler = SocketModeFunctions_1.defaultProcessEventErrorHandler,
    }) {
      ...
      if (this.installer !== void 0 || customRoutes.length) {
        const installPath =
          installerOptions.installPath === void 0 ? "/slack/install" : installerOptions.installPath;
        ...
        this.httpServer = (0, node_http_1$1.createServer)(async (req, res) => {
          ...
          if (this.installer) {
            ...
            const redirectUriPath =
              installerOptions.redirectUriPath === void 0
          ...
          if (customRoutes.length && req.url) {
            ...
            for (let i = 0; i < routes.length; i += 1) {
              const route = routes[i];
              const pathMatch = (0, path_to_regexp_1.match)(route, { decode: decodeURIComponent })(
                path,
              );
              if (pathMatch && this.routes[route][method] !== void 0) {
                const params = pathMatch.params;
          ...
          this.logger.info(
            `An unhandled HTTP request (${req.method}) made to ${req.url} was ignored`,
          );
          res.writeHead(404, {});
          res.end();
        });
        ...
        if (this.installer)
          this.logger.debug(
            `Go to http://localhost:${this.httpServerPort}${installPath} to initiate OAuth flow`,
          );
      }
...
var require_App = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  const tokenUsage =
    "Apps used in a single workspace can be initialized with a token. Apps used in many workspaces should be initialized with oauth installer options or authorize.";
  var logger_2 = require_dist$4();
  Object.defineProperty(exports, "LogLevel", {
    enumerable: true,
    get: function () {
  ...
  var App = class {
    ...
    constructor({
      ...
      if (clientTls !== void 0 && this.clientOptions.tls === void 0)
      ...
      if (socketMode && port !== void 0 && this.installerOptions.port === void 0)
      ...
      if (
        ...
        this.installerOptions.callbackOptions = {
          failure: (error, _installOptions, _req, res) => {
            ...
            res.end(
              `<html><body><h1>OAuth failed!</h1><div>${escapeHtml(error.code)}</div></body></html>`,
            );
          },
        };
      }
    ...
    event(eventNameOrPattern, ...listeners) {
      ...
      if (typeof eventNameOrPattern === "string")
        invalidEventName = eventNameOrPattern.startsWith("message.");
      else if (eventNameOrPattern instanceof RegExp)
        invalidEventName = eventNameOrPattern.source.startsWith("message\\.");
      if (invalidEventName)
        throw new errors_1.AppInitializationError(
    ...
    message(...patternsOrMiddleware) {
      const messageMiddleware = patternsOrMiddleware.map((patternOrMiddleware) => {
        if (
          ...
          node_util_1.default.types.isRegExp(patternOrMiddleware)
        )
    ...
    shortcut(callbackIdOrConstraints, ...listeners) {
      const constraints =
        ...
        node_util_1.default.types.isRegExp(callbackIdOrConstraints)
    ...
    action(actionIdOrConstraints, ...listeners) {
      const constraints =
        ...
        node_util_1.default.types.isRegExp(actionIdOrConstraints)
    ...
    async processEvent(event) {
      ...
      let authorizeResult;
      if (
        type === helpers_1.IncomingEventType.Event &&
        (0, helpers_1.isEventTypeToSkipAuthorize)(event)
      )
        authorizeResult = {
      ...
      if (authorizeResult.userId === void 0 && source.userId !== void 0)
        authorizeResult.userId = source.userId;
      if (authorizeResult.teamId === void 0 && source.teamId !== void 0)
        authorizeResult.teamId = source.teamId;
      if (authorizeResult.enterpriseId === void 0 && source.enterpriseId !== void 0)
      ...
      if (typeof event.customProperties !== "undefined") {
        ...
        if (typeof types_1.contextBuiltinKeys.find((key) => key in customProps) !== "undefined")
          throw new errors_1.InvalidCustomPropertyError(
      ...
      const { functionExecutionId, functionBotAccessToken, functionInputs } =
        extractFunctionContext(body);
      if (functionExecutionId) {
      ...
      if (conversationId !== void 0 && type !== helpers_1.IncomingEventType.Options)
      ...
      try {
        await (0, process_1.default)(
          ...
          async () => {
            ...
            const rejectedListenerResults = (await Promise.allSettled(listenerResults)).filter(
              utilities_1.isRejected,
            );
            if (rejectedListenerResults.length === 1) throw rejectedListenerResults[0].reason;
            else if (rejectedListenerResults.length > 1)
              throw new errors_1.MultipleListenerError(
    ...
    initReceiver(
      ...
      if (signatureVerification === true && signingSecret === void 0)
        throw new errors_1.AppInitializationError(
          "signingSecret is required to initialize the default receiver. Set signingSecret or use a custom receiver. You can find your Signing Secret in your Slack App Settings.",
        );
    ...
    initAuthorizeIfNoTokenIsGiven(token, authorize) {
      ...
      if (httpReceiver.installer !== void 0 && httpReceiver.installer.authorize !== void 0)
        usingOauth = true;
      if (token !== void 0) {
        if (usingOauth || authorize !== void 0)
          throw new errors_1.AppInitializationError(
            `You cannot provide a token along with either oauth installer options or authorize. ${tokenUsage}`,
          );
        return;
      }
      if (authorize === void 0 && !usingOauth)
        throw new errors_1.AppInitializationError(
      ...
      else if (authorize !== void 0 && usingOauth)
        throw new errors_1.AppInitializationError(
    ...
    initAuthorizeInConstructor(token, authorize, authorization) {
      ...
      if (token !== void 0 && authorization !== void 0)
  ...
  function runAuthTestForBotToken(client, authorization) {
    return authorization.botUserId !== void 0 && authorization.botId !== void 0
      ? Promise.resolve({
    ...
    const teamId = (() => {
      if (type === helpers_1.IncomingEventType.Event) {
        ...
        if (
          ...
          bodyAsEvent.authorizations[0] !== void 0 &&
    ...
    return {
      userId: (() => {
        if (type === helpers_1.IncomingEventType.Event) {
          ...
          if ("subteam" in event && event.subteam.created_by !== void 0)
...
var require_ExpressReceiver = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.buildBodyParserMiddleware =
    exports.verifySignatureAndParseBody =
    exports.verifySignatureAndParseRawBody =
  ...
  function verifyRequestSignature(signingSecret, body, signature, requestTimestamp) {
    if (signature === void 0 || requestTimestamp === void 0)
      throw new errors_1.ReceiverAuthenticityError(
    ...
    if (ts < Math.floor(Date.now() / 1e3) - 300)
      throw new errors_1.ReceiverAuthenticityError(
...
var require_AssistantThreadContextStore = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  var DefaultThreadContextStore = class {
    ...
    async get(args) {
      ...
      const { channelId: channel, threadTs: thread_ts } = (0, Assistant_1.extractThreadInfo)(
        payload,
      );
      ...
      const initialMsg = thread.messages.find(
        (m) => !("subtype" in m) && m.user === context.botUserId,
      );
    ...
    async save(args) {
      ...
      } = (0, Assistant_1.extractThreadInfo)(payload);
...
var require_Assistant = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.extractThreadInfo =
    exports.processAssistantMiddleware =
    exports.validate =
    exports.isAssistantMessage =
    exports.matchesConstraints =
    exports.isAssistantEvent =
    exports.enrichAssistantArgs =
    exports.Assistant =
      void 0;
  ...
  var Assistant = class {
    ...
    constructor(config) {
      validate(config);
      const {
        threadContextStore = new AssistantThreadContextStore_1.DefaultThreadContextStore(),
        threadStarted,
    ...
    async processEvent(args) {
      const { payload } = args;
      return processAssistantMiddleware(
        enrichAssistantArgs(this.threadContextStore, args),
        this.getAssistantMiddleware(payload),
      );
    }
    /**
  ...
  function isAssistantMessage(payload) {
    ...
    const inAssistantContainer =
      ...
      (!("subtype" in payload) || payload.subtype === "file_share" || payload.subtype === void 0);
  ...
  function validate(config) {
    if (typeof config !== "object")
      throw new errors_1.AssistantInitializationError(
        "Assistant expects a configuration object as the argument",
      );
    ...
    if (config.threadContextStore) {
      if (typeof config.threadContextStore !== "object")
        throw new errors_1.AssistantInitializationError(
          "Assistant expects threadContextStore to be a configuration object",
        );
      const requiredContextKeys = ["get", "save"];
      const missingContextKeys = [];
      for (const k of requiredContextKeys)
        if (config.threadContextStore && config.threadContextStore[k] === void 0)
  ...
  async function processAssistantMiddleware(args, middleware) {
    ...
    if (lastCallback !== void 0)
      await (0, process_1.default)(callbacks, args, context, client, logger, async () =>
        lastCallback({
          ...args,
          context,
          client,
  ...
  function extractThreadInfo(payload) {
    ...
    if (
      ...
      if (
        typeof payload.assistant_thread.context === "object" &&
        payload.assistant_thread.context !== null
      )
...
var require_WorkflowStep = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.prepareStepArgs =
    exports.isStepEvent =
    exports.processStepMiddleware =
    exports.validate =
  ...
  function validate(callbackId, config) {
    if (typeof callbackId !== "string")
      throw new errors_1.WorkflowStepInitializationError(
        "WorkflowStep expects a callback_id as the first argument",
      );
    if (typeof config !== "object")
      throw new errors_1.WorkflowStepInitializationError(
        "WorkflowStep expects a configuration object as the second argument",
      );
    ...
    for (const fn of ["save", "edit", "execute"])
      if (typeof config[fn] !== "function" && !Array.isArray(config[fn])) {
...
var require_dist = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  exports.webApi =
    exports.types =
    exports.FileInstallationStore =
    exports.MemoryInstallationStore =
    exports.WorkflowStep =
    exports.Assistant =
    exports.buildReceiverRoutes =
    exports.MemoryStore =
    exports.defaultProcessEventErrorHandler =
    exports.HTTPResponseAck =
    exports.HTTPModuleFunctions =
    exports.AwsLambdaReceiver =
    exports.HTTPReceiver =
    exports.SocketModeReceiver =
    exports.ExpressReceiver =
    exports.isValidSlackRequest =
    exports.verifySlackRequest =
    exports.App =
    exports.LogLevel =
      void 0;
...
function buildSlackPluginInteractionData(params) {
  ...
  const payload =
    ...
    "";
  if (actionId === "openclaw:reply_button" || actionId === "openclaw:reply_select")
    return payload || null;
...
function resolveSlackRoomContextHints(params) {
  ...
  const systemPromptParts = [params.channelConfig?.systemPrompt?.trim() || null].filter((entry) =>
    Boolean(entry),
  );
  return {
  ...
  if (threadInitialHistoryLimit > 0 && !threadSessionPreviousTimestamp) {
    ...
    if (threadHistory.length > 0) {
      ...
      for (const historyMsg of threadHistory) {
        const msgSenderName =
          (historyMsg.userId ? userMap.get(historyMsg.userId) : null)?.name ??
...
async function prepareSlackMessage(params) {
  ...
  const ackReactionPromise =
    shouldAckReaction$1() && ackReactionMessageTs && ackReactionValue
...
function loadSlashCommandsRuntime() {
  slashCommandsRuntimePromise ??= import("./slash-commands.runtime-DVUk4dU9.js");
  return slashCommandsRuntimePromise;
}
function loadSlashDispatchRuntime() {
  slashDispatchRuntimePromise ??= import("./slash-dispatch.runtime-CjgBTpme.js");
  return slashDispatchRuntimePromise;
}
function loadSlashSkillCommandsRuntime() {
  slashSkillCommandsRuntimePromise ??= import("./slash-skill-commands.runtime-Dr-g7lvV.js");
...
function resolveSlackBoltInterop(params) {
  ...
  if (isConstructorFunction(defaultImport) && isConstructorFunction(namespaceReceiver))
    return {
      App: defaultImport,
    ...
    if (slackMode === "socket") {
      ...
      while (!opts.abortSignal?.aborted) {
        try {
          ...
          runtime.error?.(
            `slack socket mode failed to start. retry ${reconnectAttempts}/${SLACK_SOCKET_RECONNECT_POLICY.maxAttempts || "∞"} in ${Math.round(delayMs / 1e3)}s (${formatUnknownError(err)})`,
          );
          try {
...
//#endregion
export {
  listSlackDirectoryPeersLive as i,
  monitorSlackProvider as n,
  listSlackDirectoryGroupsLive as r,
  probeSlack as t,
};
