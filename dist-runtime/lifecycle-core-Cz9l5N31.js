import {
  a as resolveGatewayDriftCheckCredentialsFromConfig,
...
import {
  ...
  m as emitDaemonActionJson,
  p as createNullWriter,
...
async function runServiceRestart(params) {
  ...
  if (loaded && params.checkTokenDrift)
    try {
      const serviceToken = (await params.service.readCommand(process.env))?.environment
