...
import { t as DANGEROUS_ACP_TOOLS } from "./dangerous-tools-DNBw4s62.js";
...
import {
  a as omitEnvKeysCaseInsensitive,
  r as listKnownProviderAuthEnvVarNames,
} from "./provider-env-vars-h4NFBrJS.js";
import { t as readSecretFromFile } from "./secret-file-BE6KRzam.js";
import { l as defaultRuntime } from "./subsystem-BZRyMoTO.js";
import { r as theme } from "./theme-CWrxY1-_.js";
import { r as listThinkingLevels } from "./thinking-D1lo1J1T.js";
import { r as isKnownCoreToolId } from "./tool-catalog-BACJpgR-.js";
...
function resolveToolPathCandidate(params, toolName, toolTitle) {
  const fromRawInput = readFirstStringValue(
    asRecord$1(params.toolCall?.rawInput),
    READ_TOOL_PATH_KEYS,
  );
...
async function createAcpClient(opts = {}) {
  ...
  const { getActiveSkillEnvKeys } = await import("./env-overrides.runtime-DBxQMsf_.js");
...
function formatToolTitle(name, args) {
  ...
  return `${base}: ${Object.entries(args)
    .map(([key, value]) => {
