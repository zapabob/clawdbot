...
function operatorScopeSatisfied(requestedScope, granted) {
  if (granted.has(OPERATOR_ADMIN_SCOPE) && requestedScope.startsWith(OPERATOR_SCOPE_PREFIX$1))
    return true;
...
//#endregion
export {
  rejectDevicePairing as a,
  revokeDeviceToken as c,
  updatePairedDeviceMetadata as d,
  verifyDeviceToken as f,
  listDevicePairing as i,
  rotateDeviceToken as l,
  roleScopesAllow as m,
  ensureDeviceToken as n,
  removePairedDevice as o,
  resolveMissingRequestedScope as p,
  getPairedDevice as r,
  requestDevicePairing as s,
  approveDevicePairing as t,
  summarizeDeviceTokens as u,
};
