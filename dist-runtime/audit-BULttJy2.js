import { dt as normalizeTrustedSafeBinDirs, pt as listRiskyConfiguredSafeBins } from "./io-BeL7sW7Y.js";
...
import { n as formatPermissionRemediation, r as inspectPathPermissions, t as formatPermissionDetail } from "./audit-fs-BVqUNCSg.js";
import { E as resolveSandboxConfigForAgent } from "./docker-Cqnwb08y.js";
import { a as isBlockedHostnameOrIp, o as isPrivateNetworkAllowedByPolicy } from "./ssrf-wZ7QiQYw.js";
import { i as loadExecApprovals } from "./exec-approvals-BmEFrzOW.js";
import { n as resolveBrowserConfig, r as resolveProfile } from "./config-DKL8TOiP.js";
import { a as resolveGatewayAuth } from "./auth-DQHfNzzJ.js";
import { Y as resolveBrowserControlAuth, f as redactCdpUrl } from "./routes-DbO6sePn.js";
import { a as listInterpreterLikeSafeBins, r as isInterpreterLikeAllowlistPattern, s as resolveMergedSafeBinProfileFixtures } from "./exec-inline-eval-C1SCNOS1.js";
import { n as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-DNBw4s62.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-CvXwAliw.js";
...
async function loadChannelPlugins() {
	channelPluginsModulePromise ??= import("./plugins-CHPZ4kQf.js");
	return await channelPluginsModulePromise;
}
async function loadAuditNonDeepModule() {
	auditNonDeepModulePromise ??= import("./audit.nondeep.runtime-BqG2jRqZ.js");
	return await auditNonDeepModulePromise;
}
async function loadAuditDeepModule() {
	auditDeepModulePromise ??= import("./audit.deep.runtime-ID5KPe1o.js");
	return await auditDeepModulePromise;
}
async function loadAuditChannelModule() {
	auditChannelModulePromise ??= import("./audit-channel.collect.runtime-D7uyFv85.js");
	return await auditChannelModulePromise;
}
async function loadGatewayProbeDeps() {
	gatewayProbeDepsPromise ??= Promise.all([
		import("./call-BrroQmBr.js"),
		import("./probe-auth-YlVkBoGi.js"),
		import("./probe-XYAQpR2J.js")
