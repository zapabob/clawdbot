import { i as resolveGatewayCredentialsFromValues } from "./credentials-ISiLam_U.js";
import {
  a as isTrustedProxyAddress,
  f as resolveRequestClientIp,
  l as resolveClientIp,
  n as isLoopbackAddress,
  t as isLocalishHost,
} from "./net-B1gQyBKw.js";
import { t as safeEqualSecret } from "./secret-equal-BiA3txY3.js";
import { c as readTailscaleWhoisIdentity } from "./tailscale-D5EfGD33.js";
...
function isLocalDirectRequest(req, trustedProxies, allowRealIpFallback = false) {
  if (!req) return false;
  if (!isLoopbackAddress(resolveRequestClientIp(req, trustedProxies, allowRealIpFallback) ?? ""))
    return false;
...
//#endregion
export {
  resolveGatewayAuth as a,
  AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET as c,
  isLocalDirectRequest as i,
  createAuthRateLimiter as l,
  authorizeHttpGatewayConnect as n,
  AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN as o,
  authorizeWsControlUiGatewayConnect as r,
  AUTH_RATE_LIMIT_SCOPE_HOOK_AUTH as s,
  assertGatewayAuthConfigured as t,
  normalizeRateLimitClientIp as u,
};
