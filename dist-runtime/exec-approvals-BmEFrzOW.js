...
import {
  ...
  Dt as resolvePolicyTargetResolution,
  Et as resolvePolicyTargetCandidatePath,
  Ht as DEFAULT_SAFE_BINS,
  It as POSIX_INLINE_COMMAND_FLAGS,
  Mt as extractShellWrapperInlineCommand,
  Pt as isShellWrapperExecutable,
  Rt as resolveInlineCommandMatch,
  Tt as resolveExecutionTargetResolution,
  Ut as SAFE_BIN_PROFILES,
  Vt as normalizeExecutableToken,
  bt as splitCommandChain,
  ft as validateSafeBinArgv,
  gt as analyzeShellCommand,
  kt as resolveExecWrapperTrustPlan,
  lt as isTrustedSafeBinPath,
  vt as isWindowsPlatform,
  wt as resolveExecutionTargetCandidatePath,
  xt as matchAllowlist,
} from "./io-BeL7sW7Y.js";
...
//#endregion
export {
  requestJsonlSocket as S,
  saveExecApprovals as _,
  maxAsk as a,
  resolveAllowAlwaysPatterns as b,
  normalizeExecApprovals as c,
  normalizeExecSecurity as d,
  readExecApprovalsSnapshot as f,
  resolveExecApprovalsFromFile as g,
  resolveExecApprovals as h,
  loadExecApprovals as i,
  normalizeExecAsk as l,
  requiresExecApproval as m,
  addAllowlistEntry as n,
  mergeExecApprovalsSocketDefaults as o,
  recordAllowlistUse as p,
  ensureExecApprovals as r,
  minSecurity as s,
  DEFAULT_EXEC_APPROVAL_TIMEOUT_MS as t,
  normalizeExecHost as u,
  evaluateExecAllowlist as v,
  resolveSafeBins as x,
  evaluateShellAllowlist as y,
};
