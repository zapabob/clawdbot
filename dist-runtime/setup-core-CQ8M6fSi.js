import {
  Eb as mergeDiscordAccountConfig,
  Mb as resolveDiscordToken,
  Vh as createStandardChannelSetupStatus,
  Wb as listCombinedAccountIds,
  kb as resolveDiscordAccountConfig,
...
function createLegacyCompatChannelDmPolicy(params) {
  return {
    ...
    getCurrent: (cfg) =>
      cfg.channels?.[params.channel]?.dmPolicy ??
      cfg.channels?.[params.channel]?.dm?.policy ??
      "pairing",
    ...
    credentials: [
      {
        ...
        inspect: ({ cfg, accountId }) => {
          ...
          return {
            ...
            envValue:
              accountId === "default" ? process.env.DISCORD_BOT_TOKEN?.trim() || void 0 : void 0,
          };
        },
      },
    ],
...
export {
  ...
  parseDiscordAllowFromId as i,
  createDiscordSetupWizardProxy as n,
  resolveEntriesWithOptionalToken as o,
  discordSetupAdapter as r,
  resolveDiscordSetupAccountConfig as s,
  createDiscordSetupWizardBase as t,
};
