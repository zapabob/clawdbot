...
import {
  ...
  eb as findCodeRegions,
  ec as formatIMessageChatTarget,
  ...
  uf as resolveOutboundAttachmentFromUrl,
...
import {
  ...
  u as resolveDualTextControlCommandGate,
...
import {
  F as resolveIMessageRemoteAttachmentRoots,
  I as normalizeScpRemoteHost,
  M as isInboundPathAllowed,
  P as resolveIMessageAttachmentRoots,
  s as loadConfig,
} from "./io-BeL7sW7Y.js";
...
async function monitorIMessageProvider(opts = {}) {
  ...
  try {
    subscriptionId =
      (await client.request("watch.subscribe", { attachments: includeAttachments }))
        ?.subscription ?? null;
...
//#endregion
export {
  normalizeIMessageMessagingTarget as i,
  sendMessageIMessage as n,
  probeIMessage as r,
  monitorIMessageProvider as t,
};
