import {
  A as listThinkingLevels$1,
  E as formatThinkingLevels$1,
  N as normalizeProviderId$1,
  O as isBinaryThinkingProvider$1,
  k as listThinkingLevelLabels$1,
  z as supportsBuiltInXHighThinking,
...
function formatThinkingLevels(provider, model, separator = ", ") {
  return supportsXHighThinking(provider, model)
    ...
    : formatThinkingLevels$1(provider, model, separator);
}
//#endregion
export {
  supportsXHighThinking as i,
  listThinkingLevelLabels as n,
  listThinkingLevels as r,
