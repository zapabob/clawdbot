...
import { Ya as getMachineDisplayName, mu as resolveSystemRunCommandRequest, pa as withTimeout, pu as formatExecCommand, yu as normalizeSystemRunApprovalPlan } from "./account-resolution-YAil9v6G.js";
import { At as POSIX_SHELL_WRAPPERS, Bt as unwrapKnownDispatchWrapperInvocation, Ct as resolveCommandResolutionFromArgv, Ft as unwrapKnownShellMultiplexerInvocation, It as POSIX_INLINE_COMMAND_FLAGS, Ot as resolveExecutableFromPathEnv, Rt as resolveInlineCommandMatch, St as resolveApprovalAuditCandidatePath, Vt as normalizeExecutableToken, ht as analyzeArgvCommand, s as loadConfig, yt as resolvePlannedSegmentArgv } from "./io-BeL7sW7Y.js";
...
import { h as GATEWAY_CLIENT_NAMES, m as GATEWAY_CLIENT_MODES } from "./message-channel-BTVKzHsu.js";
...
import { d as sanitizeHostExecEnv, p as sanitizeSystemRunEnvOverrides, s as inspectHostExecEnvOverrides } from "./shell-env-BOjFl6MZ.js";
...
import { S as requestJsonlSocket, _ as saveExecApprovals, b as resolveAllowAlwaysPatterns, c as normalizeExecApprovals, f as readExecApprovalsSnapshot, h as resolveExecApprovals, m as requiresExecApproval, n as addAllowlistEntry, o as mergeExecApprovalsSocketDefaults, p as recordAllowlistUse, r as ensureExecApprovals, v as evaluateExecAllowlist, y as evaluateShellAllowlist } from "./exec-approvals-BmEFrzOW.js";
...
import { _ as startBrowserControlServiceFromConfig, f as redactCdpUrl, g as createBrowserControlContext, h as createBrowserRouteDispatcher } from "./routes-DbO6sePn.js";
...
import { i as isInterpreterLikeSafeBin, n as detectInterpreterInlineEvalArgv, o as resolveExecSafeBinRuntimePolicy, t as describeInterpreterInlineEval } from "./exec-inline-eval-C1SCNOS1.js";
...
import { _ as resolveNodeWindowsTaskName, c as formatNodeServiceDescription, g as resolveNodeSystemdServiceName, h as resolveNodeLaunchAgentLabel } from "./constants-CcnbRHz3.js";
...
import { a as resolveNodeProgramArguments, n as resolveDaemonInstallRuntimeInputs, r as resolveDaemonNodeBinDir, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-D4PCKVly.js";
...
import { f as buildDaemonServiceSnapshot, h as installDaemonServiceAndEmit, n as createDaemonInstallActionContext, r as failIfNixDaemonInstallMode, t as createCliStatusTextStyles, u as resolveRuntimeStatusColor } from "./shared-6fLZ_VzH.js";
import { c as buildPlatformRuntimeLogHints, l as buildPlatformServiceStartHints, u as formatRuntimeStatus } from "./systemd-hints-BIPEJ7ys.js";
import { t as parsePort } from "./parse-port-Dqw2Fo14.js";
import { i as runServiceUninstall, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-Cz9l5N31.js";
import { n as normalizeBrowserRequestPath, r as resolveRequestedBrowserProfile, t as isPersistentBrowserProfileMutation } from "./request-policy-D17w9gI1.js";
import { i as NODE_SYSTEM_RUN_COMMANDS, n as NODE_EXEC_APPROVALS_COMMANDS, t as NODE_BROWSER_PROXY_COMMAND } from "./node-commands-HeWLVUdk.js";
