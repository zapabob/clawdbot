...
import {
  a as resolvePluginInstallDir,
  i as installPluginFromPath,
  r as installPluginFromNpmSpec,
  t as PLUGIN_INSTALL_ERROR_CODE,
} from "./install-B-SbSPl-.js";
import {
  n as recordPluginInstall,
  t as buildNpmResolutionInstallFields,
} from "./installs-CCuNe7gp.js";
    ...
    if (known.installLocation) {
      ...
      if (local?.ok) {
        const parsed = parseMarketplaceManifest(
          await fs$1.readFile(local.manifestPath, "utf-8"),
          local.manifestPath,
        );
...
//#endregion
export {
  installPluginFromMarketplace as a,
  readInstalledPackageVersion as i,
  updateNpmInstalledPlugins as n,
  listMarketplacePlugins as o,
  expectedIntegrityForUpdate as r,
  resolveMarketplaceInstallShortcut as s,
  syncPluginsForUpdateChannel as t,
};
