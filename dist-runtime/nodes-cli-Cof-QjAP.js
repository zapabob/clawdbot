...
import {
  Cl as writeCameraPayloadToFile,
  Cu as applyPathPrepend,
  Sl as writeCameraClipPayloadToFile,
  _l as parseCanvasSnapshotPayload,
  ai as screenRecordTempPath,
  bl as parseCameraSnapPayload,
  ci as parseTimeoutMs,
  gl as canvasSnapshotTempPath,
  ii as parseScreenRecordPayload,
  oi as writeScreenRecordToFile,
  si as parseEnvPairs,
  uu as parsePreparedSystemRunPayload,
  vl as cameraTempPath,
  xl as writeBase64ToFile,
  xu as buildNodeShellCommand,
  yl as parseCameraClipPayload,
} from "./account-resolution-YAil9v6G.js";
import "./paths-Chd_ukvM.js";
import "./globals-BKVgh_pY.js";
import { f as resolveDefaultAgentId, i as resolveAgentConfig } from "./agent-scope-BIySJgkJ.js";
import { c as randomIdempotencyKey } from "./call-C8P8TkMb.js";
import { n as runCommandWithRuntime } from "./cli-utils-psLCXXsK.js";
import "./ansi-D3lUajt1.js";
import {
  a as maxAsk,
  d as normalizeExecSecurity,
  g as resolveExecApprovalsFromFile,
  i as loadExecApprovals,
  l as normalizeExecAsk,
  s as minSecurity,
  t as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS,
...
import { i as parsePairingList, r as parseNodeList } from "./node-resolve-BtsYvt24.js";
import {
  a as resolveNodeId,
  i as resolveNode,
  n as callGatewayCli,
...
import { S as shortenHomePath, x as shortenHomeInString } from "./utils-DGUUVa38.js";
...
async function resolveNodePlatform(opts, nodeId) {
  try {
    const match = parseNodeList(await callGatewayCli("node.list", opts, {})).find(
...
async function prepareNodesRunContext(params) {
  ...
  return {
    prepared: requirePreparedRunPayload(
      (
...
async function resolveNodeApprovals(params) {
  ...
  const approvalsFile =
    approvalsSnapshot && typeof approvalsSnapshot === "object" ? approvalsSnapshot.file : void 0;
...
async function maybeRequestNodesRunApproval(params) {
  ...
  let approvalId = null;
  if (!(params.hostAsk === "always" || params.hostAsk === "on-miss"))
    return {
      approvedByAsk,
      approvalDecision,
      approvalId,
...
function buildSystemRunInvokeParams(params) {
  ...
  if (params.approvalPlan.agentId ?? params.fallbackAgentId)
    invokeParams.params.agentId = params.approvalPlan.agentId ?? params.fallbackAgentId;
  if (params.approvalPlan.sessionKey)
    invokeParams.params.sessionKey = params.approvalPlan.sessionKey;
...
function registerNodesInvokeCommands(nodes) {
  ...
  nodesCallOpts(
    nodes
      ...
      .option("--env <key=val>", "Environment override (repeatable)", (value, prev = []) => [
        ...prev,
        value,
      ])
      ...
      .action(async (opts) => {
        await runNodesCommand("location get", async () => {
          ...
          const desiredAccuracyRaw =
            typeof opts.accuracy === "string" ? opts.accuracy.trim().toLowerCase() : void 0;
