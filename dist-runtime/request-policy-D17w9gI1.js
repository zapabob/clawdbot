...
function resolveRequestedBrowserProfile(params) {
  const queryProfile =
    typeof params.query?.profile === "string" ? params.query.profile.trim() : void 0;
...
//#endregion
export {
  normalizeBrowserRequestPath as n,
  resolveRequestedBrowserProfile as r,
  isPersistentBrowserProfileMutation as t,
};
