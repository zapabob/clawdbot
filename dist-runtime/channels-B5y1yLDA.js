...
import { D_ as moveSingleAccountChannelSectionToDefaultAccount, Dr as formatUsageReportLines, Er as loadProviderUsageSummary, Ic as resolveCommandSecretRefsViaGateway, cu as resolveMessageActionDiscoveryForPlugin, jc as resolveMessageChannelSelection, su as createMessageActionDiscoveryContext } from "./account-resolution-YAil9v6G.js";
...
import { p as getResolvedLoggerSettings, t as danger } from "./globals-BKVgh_pY.js";
import { r as theme } from "./theme-CWrxY1-_.js";
import "./utils-DGUUVa38.js";
import { l as defaultRuntime, u as writeRuntimeJson } from "./subsystem-BZRyMoTO.js";
...
import { c as loadAuthProfileStore } from "./profiles-DothReVm.js";
...
import { f as getChannelPlugin, m as normalizeChannelId, p as listChannelPlugins } from "./plugins-AUGbKgu9.js";
...
import { a as isCatalogChannelInstalled, r as runCollectedChannelOnboardingPostWriteHooks, t as createChannelOnboardingPostWriteHookCollector } from "./onboard-channels-a3AV7afv.js";
import { n as hasResolvedCredentialValue, t as hasConfiguredUnavailableCredentialStatus } from "./account-snapshot-fields-foxLy_VQ.js";
...
import "./send-DnN1-Sre.js";
import "./reactions--IAyT0-F.js";
import "./minimal-B0enKJkF.js";
import "./monitor-CMtQU_o22.js";
import "./runtime-api-mA2BgZV0.js";
import "./setup-core-C5AO0Myq2.js";
import "./setup-core-w7EBN6u4.js";
import "./accounts-DD9J-j_R.js";
import "./runtime-api-j7kJbVIJ.js";
import "./runtime-CEBJRx-j.js";
...
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-MlGTW-kQ.js";
import { n as buildReadOnlySourceChannelAccountSnapshot, t as buildChannelAccountSnapshot } from "./status-C9liWluS.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-CfcLlzuL.js";
import "./setup-group-access-CJUzc8dq.js";
import { t as parseLogLine } from "./parse-log-line-CHZFr5nt.js";
import { i as describeBinding, n as applyAgentBindings, t as requireValidConfigSnapshot } from "./config-validation-BizX2kDI.js";
...
async function channelsAddCommand(opts, runtime = defaultRuntime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, { setupChannels }] = await Promise.all([import("./agents.config-ChunHb6V.js"), import("./onboard-channels-CK983RbG.js")]);
	...
	const loadScopedPlugin = async (channelId, pluginId) => {
		...
		const { loadChannelSetupPluginRegistrySnapshotForChannel } = await import("./plugin-install-Jhe-8xqJ.js");
	...
	if (!channel && catalogEntry) {
		...
		if (!isCatalogChannelInstalled({
			...
			const { ensureChannelSetupPluginInstalled } = await import("./plugin-install-Jhe-8xqJ.js");
			const prompter = createClackPrompter();
