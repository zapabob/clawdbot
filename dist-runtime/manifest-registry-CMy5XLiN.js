...
import {
  ...
  i as safeRealpathSync,
  l as detectBundleManifestFormat,
  m as getPackageManifestMetadata,
  n as formatPosixMode,
  p as DEFAULT_PLUGIN_ENTRY_CANDIDATES,
  r as isPathInside,
...
function deriveIdHint(params) {
  ...
  const normalizedPackageId =
    canonicalPackageId.endsWith("-provider") && canonicalPackageId.length > 9
      ? canonicalPackageId.slice(0, -9)
      : canonicalPackageId;
...
//#endregion
export {
  resolvePluginCacheInputs as a,
  discoverOpenClawPlugins as i,
  loadPluginManifestRegistry as n,
  resolvePluginSourceRoots as o,
  clearPluginDiscoveryCache as r,
  resolveBundledPluginsDir as s,
  clearPluginManifestRegistryCache as t,
};
