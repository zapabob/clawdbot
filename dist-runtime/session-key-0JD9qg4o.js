...
function canonicalizeAccountId(value) {
  ...
  return value
    ...
    .replace(LEADING_DASH_RE$1, "")
    .replace(TRAILING_DASH_RE$1, "")
    .slice(0, 64);
}
...
//#endregion
export {
  isCronSessionKey as C,
  resolveThreadParentSessionKey as E,
  isCronRunSessionKey as S,
  parseAgentSessionKey as T,
  normalizeOptionalAccountId as _,
  classifySessionKeyShape as a,
  getSubagentDepth as b,
  normalizeMainKey as c,
  sanitizeAgentId as d,
  scopedHeartbeatWakeOptions as f,
  normalizeAccountId as g,
  DEFAULT_ACCOUNT_ID as h,
  buildAgentPeerSessionKey as i,
  resolveAgentIdFromSessionKey as l,
  toAgentStoreSessionKey as m,
  DEFAULT_MAIN_KEY as n,
  isValidAgentId as o,
  toAgentRequestSessionKey as p,
  buildAgentMainSessionKey as r,
  normalizeAgentId as s,
  DEFAULT_AGENT_ID as t,
  resolveThreadSessionKeys as u,
  isBlockedObjectKey as v,
  isSubagentSessionKey as w,
  isAcpSessionKey as x,
  deriveSessionChatType as y,
};
