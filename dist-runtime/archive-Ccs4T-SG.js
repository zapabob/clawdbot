...
import {
  a as openFileWithinRoot,
  o as openWritableFileWithinRoot,
  r as copyFileWithinRoot,
  t as SafeOpenError,
} from "./fs-safe-D6gPP2TP.js";
...
async function assertResolvedInsideDestination(params) {
  ...
  if (!isPathInside(params.destinationRealDir, resolved))
    throw symlinkTraversalError$1(params.originalPath);
}
...
//#endregion
export {
  resolveArchiveKind as a,
  prepareArchiveDestinationDir as c,
  isWithinDir as d,
  readJsonFile as i,
  withStagedArchiveDestination as l,
  extractArchive as n,
  resolvePackedRootDir as o,
  fileExists as r,
  mergeExtractedTreeIntoDestination as s,
  createTarEntryPreflightChecker as t,
  isWindowsDrivePath as u,
};
