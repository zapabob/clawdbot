...
import { a as getRuntimeConfigSnapshot, g as writeConfigFile, i as createConfigIO, s as loadConfig } from "./io-BeL7sW7Y.js";
import { T as resolvePreferredOpenClawTmpDir } from "./globals-BKVgh_pY.js";
import { g as resolveConfigDir, l as escapeRegExp, t as CONFIG_DIR, y as resolveUserPath } from "./utils-DGUUVa38.js";
...
import { i as getImageMetadata, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS } from "./image-ops-BehpV8Fl.js";
...
import { o as isPrivateNetworkAllowedByPolicy, s as resolvePinnedHostnameWithPolicy, t as SsrFBlockedError } from "./ssrf-wZ7QiQYw.js";
...
import { a as allocateColor, c as isValidProfileName, d as DEFAULT_AI_SNAPSHOT_MAX_CHARS, i as allocateCdpPort, l as deriveDefaultBrowserCdpPortRange, n as resolveBrowserConfig, o as getUsedColors, p as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, r as resolveProfile, s as getUsedPorts, t as parseHttpUrl, u as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS } from "./config-DKL8TOiP.js";
import { r as isLoopbackHost } from "./net-B1gQyBKw.js";
import { a as resolveGatewayAuth } from "./auth-DQHfNzzJ.js";
import { c as hasGatewayPasswordEnvCandidate, d as readGatewayTokenEnv, l as hasGatewayTokenEnvCandidate } from "./credentials-ISiLam_U.js";
...
function createProfileAvailability({ opts, profile, state, getProfileState, setProfileRunning }) {
	...
	const closePlaywrightBrowserConnectionForProfile = async (cdpUrl) => {
		try {
			await (await import("./pw-ai-D64bxtFy.js")).closePlaywrightBrowserConnection(cdpUrl ? { cdpUrl } : void 0);
		} catch {}
	};
...
//#endregion
export { resolveConfiguredSecretInputString as $, getMediaDir as A, normalizeBrowserFormFieldValue as B, parseBrowserMajorVersion as C, withNoProxyForCdpUrl as D, markPwAiLoaded as E, resolveStrictExistingPathsWithinRoot as F, withBrowserNavigationPolicy as G, assertBrowserNavigationAllowed as H, matchBrowserUrlPattern as I, ensureBrowserControlAuth as J, deleteBridgeAuthForPort as K, getBrowserProfileCapabilities as L, DEFAULT_TRACE_DIR as M, DEFAULT_UPLOAD_DIR as N, MEDIA_MAX_BYTES as O, resolveExistingPathsWithinRoot as P, mergeGatewayTailscaleConfig as Q, DEFAULT_FILL_FIELD_TYPE as R, getChromeWebSocketUrl as S, resolveGoogleChromeExecutableForPlatform as T, assertBrowserNavigationRedirectChainAllowed as U, BrowserTabNotFoundError as V, assertBrowserNavigationResultAllowed as W, ensureGatewayStartupAuth as X, resolveBrowserControlAuth as Y, mergeGatewayAuthConfig as Z, startBrowserControlServiceFromConfig as _, parseRoleRef as a, createBrowserRouteContext as b, appendCdpPath as c, normalizeCdpHttpBaseForJsonEndpoints as d, resolveConfiguredSecretInputWithFallback as et, redactCdpUrl as f, createBrowserControlContext as g, createBrowserRouteDispatcher as h, getRoleSnapshotStats as i, saveMediaBuffer as j, cleanOldMedia as k, fetchJson as l, fetchBrowserJson as m, buildRoleSnapshotFromAiSnapshot as n, formatAriaSnapshot as o, withCdpSocket as p, setBridgeAuthForPort as q, buildRoleSnapshotFromAriaSnapshot as r, normalizeCdpWsUrl as s, registerBrowserRoutes as t, resolveRequiredConfiguredSecretRefInputString as tt, getHeadersWithAuth as u, createBrowserRuntimeState as v, readBrowserVersion as w, movePathToTrash as x, stopBrowserRuntime as y, normalizeBrowserFormField as z };
