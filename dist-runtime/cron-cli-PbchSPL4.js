...
import { n as formatDurationHuman } from "./format-duration-mTHAQ2sI.js";
...
import { d as sanitizeAgentId } from "./session-key-0JD9qg4o.js";
...
import { i as parseAbsoluteTimeMs, n as resolveCronStaggerMs } from "./stagger-BsxqMI41.js";
        ...
        try {
          ...
          const payload = (() => {
            ...
            return {
              ...
              message,
              model:
                typeof opts.model === "string" && opts.model.trim() ? opts.model.trim() : void 0,
              thinking:
          ...
          const accountId =
            typeof opts.account === "string" && opts.account.trim() ? opts.account.trim() : void 0;
      ...
      .action(async (id, opts) => {
        try {
          ...
          if (scheduleRequest.kind === "direct") patch.schedule = scheduleRequest.schedule;
            ...
            const existing = (
              (await callGatewayFromCli("cron.list", opts, { includeDisabled: true }))?.jobs ?? []
            ).find((job) => job.id === id);
