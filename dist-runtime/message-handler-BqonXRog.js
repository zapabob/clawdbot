import {
  $y as stripReasoningTagsFromText,
  A as sendPollDiscord,
  Ab as resolveDiscordMaxLinesPerMessage,
  Av as EmbeddedBlockChunker,
  Ay as getSessionBindingService,
  Ca as DEFAULT_TIMING,
  Dy as isPluginOwnedSessionBindingRecord,
  E as buildDiscordInteractiveComponents,
  ...
  M as sendWebhookMessageDiscord,
  Ma as createFinalizableDraftLifecycle,
...
import {
  C as resolveForwardedMediaList,
  E as buildDiscordInboundAccessContext,
  S as resolveDiscordMessageText,
  _ as resolveDiscordWebhookId,
  a as handleDiscordDmCommandDecision,
  b as resolveDiscordChannelInfo,
  c as resolveDiscordAutoThreadReplyPlan,
  d as resolveDiscordThreadStarter,
  f as deliverDiscordReply,
  g as resolveDiscordSenderIdentity,
  h as resolveReplyContext,
  i as resolveDiscordEffectiveRoute,
  l as resolveDiscordThreadChannel,
  ...
  w as resolveMediaList,
  x as resolveDiscordMessageChannelId,
  y as hasDiscordMessageStickers,
...
import {
  ...
  r as normalizeDiscordInboundWorkerTimeoutMs,
...
const discordOutbound = {
  ...
  sendPayload: async (ctx) => {
    ...
    const rawComponentSpec =
      payload.channelData?.discord?.components ??
  ...
  ...createAttachedChannelResultAdapter({
    ...
    sendText: async ({ cfg, to, text, accountId, deps, replyToId, threadId, identity, silent }) => {
      ...
      return await (resolveOutboundSendDep(deps, "discord") ?? sendMessageDiscord)(
...
function resolveDiscordDraftStreamingChunking(cfg, accountId) {
  ...
  const draftCfg =
    resolveAccountEntry(cfg?.channels?.discord?.accounts, normalizedAccountId)?.draftChunk ??
