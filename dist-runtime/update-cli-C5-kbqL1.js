...
} from "./doctor-completion-BHmWNXtH.js";
...
import {
  a as collectInstalledGlobalPackageErrors,
  c as detectGlobalInstallManagerForRoot,
  d as resolveGlobalInstallSpec,
  f as resolveGlobalPackageRoot,
  h as readPackageVersion,
  i as cleanupGlobalRenameDirs,
  l as globalInstallArgs,
  m as readPackageName,
  n as runGatewayUpdate,
  o as createGlobalInstallEnv,
  p as normalizePackageTagInput,
  r as canResolveRegistryVersionForPackageTarget,
  s as detectGlobalInstallManagerByPresence,
  u as resolveExpectedInstalledVersionFromSpec,
...
import {
  a as terminateStaleGatewayPids,
  i as renderRestartDiagnostics,
  s as waitForGatewayHealthyRestart,
} from "./status-BaOkW377.js";
...
import {
  n as updateNpmInstalledPlugins,
  t as syncPluginsForUpdateChannel,
} from "./update-BVP7mlF6.js";
import {
  a as resolveNpmChannelTag,
  h as resolveUpdateChannelDisplay,
  l as channelToNpmTag,
  m as resolveEffectiveUpdateChannel,
  n as compareSemverStrings,
  p as normalizeUpdateChannel,
  r as fetchNpmTagVersion,
  t as checkUpdateStatus,
  u as formatUpdateChannelLabel,
...
async function ensureGitCheckout(params) {
  ...
  if (!(await pathExists(params.dir)))
...
async function updateCommand(opts) {
  ...
  const gatewayPort = resolveGatewayPort(
    configSnapshot.valid ? configSnapshot.config : void 0,
    process.env,
  );
  if (shouldRestart)
    try {
