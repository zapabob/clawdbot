import { $m as resolveCronStorePath, A_ as shouldMoveSingleAccountChannelKey, Bv as resolveApiKeyForProvider, Dv as resolveBootstrapMaxChars, Fb as formatChannelAccountsDefaultPath, Fu as resolveBootstrapContextForRun, Ib as formatSetExplicitDefaultInstruction, Ic as resolveCommandSecretRefsViaGateway, Ja as hasConfiguredMemorySecretInput, Lb as formatSetExplicitDefaultToConfiguredInstruction, Ov as resolveBootstrapTotalMaxChars, Qm as loadCronStore, Ru as analyzeBootstrapBudget, Wm as applyPluginAutoEnable, eh as saveCronStore, ep as lookupTelegramChatId, hy as loadOpenClawPlugins, ip as listTelegramAccountIds, jv as loadModelCatalog, py as resolvePluginProviders, rp as inspectTelegramAccount, sp as resolveTelegramAccount, zu as buildBootstrapInjectionStats } from "./account-resolution-YAil9v6G.js";
import { $t as resolveDiscordPreviewStreamMode, Ct as resolveCommandResolutionFromArgv, Xt as formatSlackStreamModeMigrationMessage, Y as migrateLegacyWebSearchConfig, Zt as formatSlackStreamingBooleanMigrationMessage, an as resolveNormalizedProviderModelMaxTokens, cn as normalizeTalkSection, ct as getTrustedSafeBinDirs, d as readConfigFileSnapshot, dt as normalizeTrustedSafeBinDirs, en as resolveSlackNativeStreaming, g as writeConfigFile, lt as isTrustedSafeBinPath, nn as resolveTelegramPreviewStreamMode, on as DEFAULT_TALK_PROVIDER, pt as listRiskyConfiguredSafeBins, tn as resolveSlackStreamingMode } from "./io-BeL7sW7Y.js";
import { T as parseAgentSessionKey, _ as normalizeOptionalAccountId, g as normalizeAccountId, h as DEFAULT_ACCOUNT_ID } from "./session-key-0JD9qg4o.js";
import { S as resolveRequiredHomeDir, _ as resolveStateDir, d as resolveIsNixMode, h as resolveOAuthDir, t as CONFIG_PATH, u as resolveGatewayPort } from "./paths-Chd_ukvM.js";
...
import { _ as DEFAULT_AGENTS_FILENAME, a as resolveAgentDir, d as resolveAgentWorkspaceDir, f as resolveDefaultAgentId } from "./agent-scope-BIySJgkJ.js";
...
import { _ as resolveHooksGmailModel, a as getModelRefStatus, h as resolveConfiguredModelRef } from "./model-selection-CNzhkJya.js";
import { n as parseToolsBySenderTypedKey, r as migrateLegacyConfig } from "./config-Cfud9qZm.js";
import { p as updateAuthProfileStoreWithLock, s as ensureAuthProfileStore } from "./profiles-DothReVm.js";
import { f as resolveApiKeyForProfile, l as resolveProfileUnusableUntilForDisplay, p as repairOAuthProfileIdMismatch } from "./auth-profiles-BWz6ST0A.js";
import { t as describeUnknownError } from "./shared-BlEKeqBd.js";
import { i as resolveMainSessionKey } from "./main-session-lKLHSGId.js";
import { D as resolveSandboxScope, M as DEFAULT_SANDBOX_BROWSER_IMAGE, P as DEFAULT_SANDBOX_IMAGE } from "./docker-Cqnwb08y.js";
import { n as loadSessionStore } from "./store-Bo1TX1Sc.js";
import { n as isPrimarySessionTranscriptFileName, t as formatSessionArchiveTimestamp } from "./artifacts-D6HH48iF.js";
import { p as listChannelPlugins } from "./plugins-AUGbKgu9.js";
import { i as resolveAgentSessionDirs } from "./sessions-CD_-8zJN.js";
import { c as resolveSessionTranscriptsDirForAgent, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-0NHK4yJk.js";
import { n as cleanStaleLockFiles } from "./session-write-lock-D4oaWfci.js";
import { h as collectProviderDangerousNameMatchingScopes, r as resolveDmAllowState } from "./dm-policy-shared-D3Y8oBe8.js";
...
import { C as parseBrowserMajorVersion, T as resolveGoogleChromeExecutableForPlatform, et as resolveConfiguredSecretInputWithFallback, w as readBrowserVersion } from "./routes-DbO6sePn.js";
...
import { a as listInterpreterLikeSafeBins, s as resolveMergedSafeBinProfileFixtures } from "./exec-inline-eval-C1SCNOS1.js";
import { n as buildGatewayConnectionDetails, r as callGateway } from "./call-C8P8TkMb.js";
import { f as resolveGatewaySystemdServiceName, h as resolveNodeLaunchAgentLabel, l as resolveGatewayLaunchAgentLabel, p as resolveGatewayWindowsTaskName } from "./constants-CcnbRHz3.js";
...
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-Rbuzi9Qg.js";
import { t as note$1 } from "./note-DRnYkG2j.js";
import { a as resolveSystemNodeInfo, r as renderSystemNodeWarning } from "./runtime-paths-bnAkfJBM.js";
...
import { f as printWizardHeader, m as randomToken, n as applyWizardMetadata, s as guardCancel } from "./onboard-helpers-gr0Ez1xh.js";
import { i as launchAgentPlistExists, n as isLaunchAgentListed, r as isLaunchAgentLoaded, s as repairLaunchAgentBootstrap } from "./launchd-Cn3XWWJL.js";
import { n as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-Md1RXiZv.js";
import { d as uninstallLegacySystemdUnits, i as isSystemdUserServiceAvailable } from "./systemd-DdlU2Iy6.js";
import { c as buildPlatformRuntimeLogHints, i as auditGatewayServiceConfig, n as renderSystemdUnavailableHints, o as needsNodeRuntimeMigration, r as SERVICE_AUDIT_CODES, s as readEmbeddedGatewayToken, t as isSystemdUnavailableDetail, u as formatRuntimeStatus } from "./systemd-hints-BIPEJ7ys.js";
import { t as readLastGatewayErrorLine } from "./diagnostics-BQjY8jdF.js";
import { n as renderGatewayServiceCleanupHints, t as findExtraGatewayServices } from "./inspect-CvR5p75s.js";
import { r as healthCommand } from "./health-DFX6IFf6.js";
import { i as resolveControlUiDistIndexPathForRoot, r as resolveControlUiDistIndexHealth } from "./control-ui-assets-BgZDmYgo.js";
import { g as normalizeStoredCronJobs, n as runGatewayUpdate, t as runStartupMatrixMigration } from "./server-startup-matrix-migration-DuhFZd7g.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-CfcLlzuL.js";
import { n as runMatrixDoctorSequence, t as cleanStaleMatrixPluginConfig } from "./matrix-BuwUMn7x.js";
import { n as resolveProviderAuthLoginCommand, t as buildProviderAuthRecoveryHint } from "./provider-auth-guidance-B-gnRxyp.js";
...
import { a as stripUnknownConfigKeys, i as resolveConfigPathTarget, n as formatConfigPath, r as noteOpencodeProviderOverrides, t as runDoctorConfigPreflight } from "./doctor-config-preflight-DwOd8iKU.js";
import { a as isMattermostMutableAllowEntry, i as isMSTeamsMutableAllowEntry, n as isGoogleChatMutableAllowEntry, o as isSlackMutableAllowEntry, r as isIrcMutableAllowEntry, s as isZalouserMutableGroupEntry, t as isDiscordMutableAllowEntry } from "./mutable-allowlist-detectors-B2iShQAi.js";
import { t as resolveDefaultChannelAccountContext } from "./channel-account-context-CA5jRtFx.js";
import { i as runLegacyStateMigrations, n as detectLegacyStateMigrations } from "./doctor-state-migrations-WZIIiS7K.js";
