...
const AUTO_AUDIO_KEY_PROVIDERS = ["openai", "groq", "deepgram", "google", "mistral"];
...
//#endregion
export {
  normalizeInboundTextNewlines as S,
  DEFAULT_IMAGE_MODELS as _,
  resolveModelEntries as a,
  MIN_AUDIO_FILE_BYTES as b,
  resolveTimeoutMs as c,
  normalizeMediaProviderId as d,
  AUTO_AUDIO_KEY_PROVIDERS as f,
  DEFAULT_AUDIO_MODELS as g,
  CLI_OUTPUT_MAX_BUFFER as h,
  resolveMaxChars as i,
  normalizeMediaUnderstandingChatType as l,
  AUTO_VIDEO_KEY_PROVIDERS as m,
  resolveConcurrency as n,
  resolvePrompt as o,
  AUTO_IMAGE_KEY_PROVIDERS as p,
  resolveMaxBytes as r,
  resolveScopeDecision as s,
  applyTemplate as t,
  resolveMediaUnderstandingScope as u,
  DEFAULT_TIMEOUT_SECONDS as v,
  finalizeInboundContext as x,
  DEFAULT_VIDEO_MAX_BASE64_BYTES as y,
};
