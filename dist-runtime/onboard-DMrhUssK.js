...
import { d as restoreTerminalState, l as defaultRuntime, u as writeRuntimeJson } from "./subsystem-BZRyMoTO.js";
...
import "./daemon-runtime-DK_wYipR.js";
import { a as ensureWorkspaceAndSessions, b as waitForGatewayReachable, c as handleReset, g as resolveControlUiLinks, m as randomToken, n as applyWizardMetadata, t as DEFAULT_WORKSPACE, u as normalizeGatewayTokenInput } from "./onboard-helpers-gr0Ez1xh.js";
import { t as runSetupWizard } from "./setup-Cn-b3ja9.js";
import { i as resolveManifestProviderOnboardAuthFlags } from "./provider-auth-choices-DchVXz9c.js";
import { n as isDeprecatedAuthChoice, r as normalizeLegacyOnboardAuthChoice } from "./auth-choice-legacy-CqW0gxsv.js";
import { r as applyLocalSetupWorkspaceConfig } from "./onboard-config-BQhvWOZp.js";
...
async function collectGatewayHealthFailureDiagnostics() {
	const diagnostics = {};
	try {
		const { resolveGatewayService } = await import("./service-DGF7nMxT.js");
	...
	try {
		const { readLastGatewayErrorLine } = await import("./diagnostics-BSKBlcO8.js");
...
async function runNonInteractiveLocalSetup(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-B84h-uev.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-BMm1JAy_.js");
