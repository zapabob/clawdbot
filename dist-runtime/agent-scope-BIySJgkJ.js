...
import { t as resolveAgentModelFallbackValues } from "./model-input-CPlj8bTU.js";
...
import { h as pathExists, y as resolveUserPath } from "./utils-DGUUVa38.js";
...
function parseWorkspaceSetupState(raw) {
  try {
    ...
    const legacyCompletedAt =
      typeof parsed.onboardingCompletedAt === "string" ? parsed.onboardingCompletedAt : void 0;
    return {
      version: WORKSPACE_STATE_VERSION,
      bootstrapSeededAt:
        typeof parsed.bootstrapSeededAt === "string" ? parsed.bootstrapSeededAt : void 0,
      setupCompletedAt:
...
//#endregion
export {
  loadWorkspaceBootstrapFiles as A,
  DEFAULT_MEMORY_FILENAME as C,
  ensureAgentWorkspace as D,
  DEFAULT_USER_FILENAME as E,
  resolveWorkspaceTemplateDir as M,
  matchesSkillFilter as N,
  filterBootstrapFilesForSession as O,
  normalizeSkillFilter as P,
  DEFAULT_MEMORY_ALT_FILENAME as S,
  DEFAULT_TOOLS_FILENAME as T,
  DEFAULT_AGENTS_FILENAME as _,
  resolveAgentDir as a,
  DEFAULT_HEARTBEAT_FILENAME as b,
  resolveAgentIdByWorkspacePath as c,
  resolveAgentWorkspaceDir as d,
  resolveDefaultAgentId as f,
  resolveSessionAgentIds as g,
  resolveSessionAgentId as h,
  resolveAgentConfig as i,
  resolveDefaultAgentWorkspaceDir as j,
  isWorkspaceSetupCompleted as k,
  resolveAgentModelFallbacksOverride as l,
  resolveRunModelFallbacksOverride as m,
  listAgentEntries as n,
  resolveAgentEffectiveModelPrimary as o,
  resolveEffectiveModelFallbacks as p,
  listAgentIds as r,
  resolveAgentExplicitModelPrimary as s,
  hasConfiguredModelFallbacks as t,
  resolveAgentSkillsFilter as u,
  DEFAULT_AGENT_WORKSPACE_DIR as v,
  DEFAULT_SOUL_FILENAME as w,
  DEFAULT_IDENTITY_FILENAME as x,
  DEFAULT_BOOTSTRAP_FILENAME as y,
};
