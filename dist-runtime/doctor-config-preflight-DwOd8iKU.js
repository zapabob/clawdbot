...
import { S as OpenClawSchema, d as readConfigFileSnapshot } from "./io-BeL7sW7Y.js";
import { n as formatConfigIssueLines } from "./issue-format-DHPo_blg.js";
import { t as note } from "./note-DRnYkG2j.js";
import { t as CONFIG_PATH } from "./paths-Chd_ukvM.js";
import { _ as resolveHomeDir, d as isRecord } from "./utils-DGUUVa38.js";
...
async function runDoctorConfigPreflight(options = {}) {
  if (options.migrateState !== false) {
    const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-cNa1FV70.js");
...
export {
  ...
  formatConfigPath as n,
  noteOpencodeProviderOverrides as r,
  runDoctorConfigPreflight as t,
};
