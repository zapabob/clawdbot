...
import {
  a as formatGatewayPidList,
  i as findVerifiedGatewayListenerPidsOnPortSync,
  n as resolveGatewayService,
  o as signalVerifiedGatewayPidSync,
} from "./service-Md1RXiZv.js";
import {
  c as renderGatewayServiceStartHints,
...
import {
  ...
  n as DEFAULT_RESTART_HEALTH_ATTEMPTS,
  o as waitForGatewayHealthyListener,
  r as renderGatewayPortHealthDiagnostics,
  s as waitForGatewayHealthyRestart,
  t as runDaemonStatus,
...
async function runDaemonInstall(opts) {
  ...
  if (loaded) {
    if (!opts.force)
      if (
        await gatewayServiceNeedsAutoNodeExtraCaCertsRefresh({
          service,
          env: process.env,
        })
      ) {
...
export {
  runDaemonStop as a,
  runDaemonStart as i,
  addGatewayServiceCommands as n,
  runDaemonUninstall as o,
  runDaemonRestart as r,
  runDaemonInstall as s,
  registerDaemonCli as t,
};
