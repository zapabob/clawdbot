...
import {
  ...
  n as resolveDefaultSessionStorePath,
...
function evaluateSessionFreshness(params) {
  ...
  const idleExpiresAt =
    params.policy.idleMinutes != null && params.policy.idleMinutes > 0
      ? params.updatedAt + params.policy.idleMinutes * 6e4
      : void 0;
...
function parseSessionThreadInfo(sessionKey) {
  ...
  return {
    ...
    threadId:
      (markerIndex === -1 ? void 0 : sessionKey.slice(markerIndex + marker.length))?.trim() ||
      void 0,
  };
}
...
//#endregion
export {
  resolveSessionResetPolicy as _,
  appendAssistantMessageToSessionTranscript as a,
  resolveMainSessionKeyFromConfig as b,
  resolveAndPersistSessionFile as c,
  emitSessionTranscriptUpdate as d,
  onSessionTranscriptUpdate as f,
  resolveChannelResetConfig as g,
  evaluateSessionFreshness as h,
  resolveAgentSessionDirs as i,
  extractDeliveryInfo as l,
  resolveSessionKey as m,
  resolveAllAgentSessionStoreTargetsSync as n,
  resolveMirroredTranscriptText as o,
  deriveSessionKey as p,
  resolveSessionStoreTargets as r,
  resolveSessionTranscriptFile as s,
  resolveAllAgentSessionStoreTargets as t,
  parseSessionThreadInfo as u,
  resolveSessionResetType as v,
  resolveThreadFlag as y,
};
