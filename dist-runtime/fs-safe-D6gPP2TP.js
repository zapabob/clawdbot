...
import {
  c as isPathInside,
  l as isSymlinkOpenError,
  o as hasNodeErrorCode,
  s as isNotFoundPathError,
  t as sameFileIdentity,
} from "./file-identity-DgWfjfnD.js";
...
async function runPinnedWriteFallback(params) {
  ...
  if (params.input.kind === "buffer")
    if (typeof params.input.data === "string")
      await fs$1.writeFile(tempPath, params.input.data, {
...
//#endregion
export {
  openFileWithinRoot as a,
  readLocalFileSafely as c,
  createRootScopedReadFile as i,
  writeFileFromPathWithinRoot as l,
  appendFileWithinRoot as n,
  openWritableFileWithinRoot as o,
  copyFileWithinRoot as r,
  readFileWithinRoot as s,
  SafeOpenError as t,
  writeFileWithinRoot as u,
};
