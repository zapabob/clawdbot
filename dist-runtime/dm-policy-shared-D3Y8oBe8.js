...
//#endregion
export {
  resolveDefaultGroupPolicy as C,
  resolveAllowlistProviderRuntimeGroupPolicy as S,
  warnMissingProviderGroupPolicyFallbackOnce as T,
  resolveDangerousNameMatchingEnabled as _,
  resolveDmGroupAccessWithLists as a,
  mergeDmAllowFromSources as b,
  resolveCommandAuthorizedFromAuthorizers as c,
  evaluateGroupRouteAccessForPolicy as d,
  evaluateMatchedGroupAccessForPolicy as f,
  isDangerousNameMatchingEnabled as g,
  collectProviderDangerousNameMatchingScopes as h,
  resolveDmGroupAccessWithCommandGate as i,
  resolveControlCommandGate as l,
  evaluateSenderGroupAccessForPolicy as m,
  readStoreAllowFromForDmPolicy as n,
  resolveEffectiveAllowFromLists as o,
  evaluateSenderGroupAccess as p,
  resolveDmAllowState as r,
  resolvePinnedMainDmOwnerFromAllowlist as s,
  DM_GROUP_ACCESS_REASON as t,
  resolveDualTextControlCommandGate as u,
  firstDefined as v,
  resolveOpenProviderRuntimeGroupPolicy as w,
  GROUP_POLICY_BLOCKED_LABEL as x,
  isSenderIdAllowed as y,
};
