import { G as SecretProviderSchema, d as readConfigFileSnapshot, g as writeConfigFile, y as validateConfigObjectRaw } from "./io-BeL7sW7Y.js";
import { v as isBlockedObjectKey } from "./session-key-0JD9qg4o.js";
import { t as CONFIG_PATH } from "./paths-Chd_ukvM.js";
import { l as success, n as info, t as danger } from "./globals-BKVgh_pY.js";
import { r as theme } from "./theme-CWrxY1-_.js";
import { S as shortenHomePath } from "./utils-DGUUVa38.js";
import { d as resolveSecretInputRef, i as coerceSecretRef, s as isValidEnvSecretRefId } from "./types.secrets-BEA4gMCN.js";
import { a as formatExecSecretRefIdValidationMessage, c as isValidSecretProviderAlias, d as validateExecSecretRefId, o as isValidExecSecretRefId, s as isValidFileSecretRefId, u as secretRefKey } from "./ref-contract-dGA3yRCz.js";
...
import { a as resolveSecretRefValue } from "./resolve-BNoFF8j-.js";
import { t as OLLAMA_DEFAULT_BASE_URL } from "./ollama-defaults-BkItzGjz.js";
import { t as formatDocsLink } from "./links-CZOLMG0R.js";
import { a as normalizeConfigIssues, n as formatConfigIssueLines } from "./issue-format-DHPo_blg.js";
import { c as resolveConfigSecretTargetByPath, n as discoverConfigSecretTargets } from "./target-registry-CwHCjIsx.js";
import "./timeouts-BYhx8htE.js";
import "./timeouts-DESBckmm.js";
import { t as redactConfigObject } from "./redact-snapshot-BbD4TRBA.js";
import { n as setCommandJsonMode } from "./json-mode-D7-j1pPY.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/unset/file/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-D_GXqK5l.js");
