...
function normalizePersistedBinding(threadIdKey, raw) {
  ...
  const webhookToken =
    typeof value.webhookToken === "string" ? value.webhookToken.trim() || void 0 : void 0;
...
//#endregion
export {
  setBindingRecord as A,
  resolveBindingIdsForSession as C,
  resolveThreadBindingMaxAgeExpiresAt as D,
  resolveThreadBindingInactivityExpiresAt as E,
  shouldPersistBindingMutations as M,
  DEFAULT_THREAD_BINDING_IDLE_TIMEOUT_MS as N,
  resolveThreadBindingMaxAgeMs as O,
  THREAD_BINDINGS_SWEEP_INTERVAL_MS as P,
  removeBindingRecord as S,
  resolveThreadBindingIdleTimeoutMs as T,
  normalizeTargetKind as _,
  isThreadArchived as a,
  rememberRecentUnboundWebhookEcho as b,
  summarizeDiscordError as c,
  PERSIST_BY_ACCOUNT_ID as d,
  THREAD_BINDING_TOUCH_PERSIST_MIN_INTERVAL_MS as f,
  isRecentlyUnboundThreadWebhookMessage as g,
  getThreadBindingToken as h,
  isDiscordThreadGoneError as i,
  shouldDefaultPersist as j,
  saveBindingsToDisk as k,
  BINDINGS_BY_THREAD_ID as l,
  forgetThreadBindingToken as m,
  createWebhookForChannel as n,
  maybeSendBindingMessage as o,
  ensureBindingsLoaded as p,
  findReusableWebhook as r,
  resolveChannelIdForBinding as s,
  createThreadForBinding as t,
  MANAGERS_BY_ACCOUNT_ID as u,
  normalizeThreadBindingDurationMs as v,
  resolveBindingRecordKey as w,
  rememberThreadBindingToken as x,
  normalizeThreadId as y,
};
