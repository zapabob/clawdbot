...
import { t as formatSessionArchiveTimestamp } from "./artifacts-D6HH48iF.js";
...
async function listAgentSessionDirs(stateDir) {
  ...
  try {
    return (await fs$1.readdir(root, { withFileTypes: true }))
...
export {
  removePath as a,
  listAgentSessionDirs as i,
  formatBackupCreateSummary as n,
  removeStateAndLinkedPaths as o,
  buildCleanupPlan as r,
  removeWorkspaceDirs as s,
