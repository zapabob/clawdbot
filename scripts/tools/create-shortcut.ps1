...
$c.Arguments = "-NoExit -ExecutionPolicy Bypass -File `"C:\Users\downl\Desktop\clawdbot-main3\clawdbot-main\scripts\launchers\launch-desktop-stack.ps1`" -SpeakOnReady"
