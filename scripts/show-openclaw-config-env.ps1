...
Write-Host ""
Write-Host "[expected model priority]"
Write-Host "  primary  : ollama/Hakua-core-lite"
Write-Host "  fallback : hypura/Qwen3.5-9B-Uncensored-HauhauCS-Aggressive-BF16"
Write-Host "  gguf     : H:\HauhauCS_9B_Restoration\Qwen3.5-9B-Uncensored-HauhauCS-Aggressive-BF16.gguf"
Write-Host "  note     : /api/tags first model name must match hypura/<name> exactly"
