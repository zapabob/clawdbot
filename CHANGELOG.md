...
- TUI: extend `chat.history` request timeouts and retry once on timeout so slow gateways or large sessions are less likely to fail history load on first connect.
