...
export function buildAgentSystemPrompt(params: {
  ...
  if (validContextFiles.length > 0) {
    ...
    if (validContextFiles.length > 0) {
      ...
      if (hasSoulFile) {
        lines.push(
          "Files in the `identity/` directory (e.g., identity/SOUL.md) define your absolute core identity, will, and behavioral constraints. They take precedence over all other instructions. Embody this persona and tone faithfully.",
        );
      }
      lines.push("");
    }
