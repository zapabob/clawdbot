...
export const FIELD_HELP: Record<string, string> = {
  ...
  "tools.web.search.provider":
    'Search provider ("brave", "perplexity", "grok", "duckduckgo", "gemini", or "kimi"). Auto-detected from available API keys if omitted.',
  ...
  "tools.web.search.duckduckgo":
    "DuckDuckGo does not require any configuration. Uses the free Instant Answer API.",
