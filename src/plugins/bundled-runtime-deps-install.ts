...
let spawnBundledRuntimeDepsProcess = spawn;
let spawnSyncBundledRuntimeDepsProcess = spawnSync;

export const __testing = {
  resetProcessLaunchersForTest(): void {
    spawnBundledRuntimeDepsProcess = spawn;
    spawnSyncBundledRuntimeDepsProcess = spawnSync;
  },
  setProcessLaunchersForTest(launchers: {
    spawn?: typeof spawn;
    spawnSync?: typeof spawnSync;
  }): void {
    spawnBundledRuntimeDepsProcess = launchers.spawn ?? spawn;
    spawnSyncBundledRuntimeDepsProcess = launchers.spawnSync ?? spawnSync;
  },
};
...
async function spawnBundledRuntimeDepsInstall(params: {
  ...
  await new Promise<void>((resolve, reject) => {
    ...
    const child = spawnBundledRuntimeDepsProcess(params.command, params.args, {
      cwd: params.cwd,
      env: params.env,
...
export function installBundledRuntimeDeps(params: {
  ...
  try {
    const result = spawnSyncBundledRuntimeDepsProcess(context.runner.command, context.runner.args, {
