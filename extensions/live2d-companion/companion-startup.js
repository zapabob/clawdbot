...
export function isSupportedCompanionModelPath(filePath) {
...
function resolveOptionalPath(repoRoot, rawPath) {
...
function rankCompanionModelCandidate(filePath) {
...
export function sortCompanionModelCandidates(filePaths) {
