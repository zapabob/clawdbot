...
const TTS_PROVIDERS = ["voicevox", "web-speech"];
function normalizeTtsProvider(value) {
  return typeof value === "string" && TTS_PROVIDERS.includes(value) ? value : undefined;
}
function resolveCompanionLocalVoiceDefaults() {
  try {
    return require("openclaw/plugin-sdk/local-voice").resolveLocalVoiceCompanionDefaults();
  } catch {
    return {
